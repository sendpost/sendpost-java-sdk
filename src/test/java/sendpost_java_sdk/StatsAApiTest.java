...
/**
 * API tests for StatsAApi
 */
@Disabled
public class StatsAApiTest {

    private final StatsAApi api = new StatsAApi();
     ...
     */
    @Test
    public void getAccountAggregateStatsTest() throws ApiException {
        LocalDate from = null;
        LocalDate to = null;
        AggregateStats response = api.getAccountAggregateStats(from, to);
     ...
     */
    @Test
    public void getAccountAggregateStatsByGroupTest() throws ApiException {
        String group = null;
        LocalDate from = null;
        LocalDate to = null;
        AggregateStat response = api.getAccountAggregateStatsByGroup(group, from, to);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAccountStatsByGroupTest() throws ApiException {
        String group = null;
        LocalDate from = null;
        LocalDate to = null;
        List<Stat> response = api.getAccountStatsByGroup(group, from, to);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAllAccountStatsTest() throws ApiException {
        LocalDate from = null;
        LocalDate to = null;
        List<AccountStats> response = api.getAllAccountStats(from, to);
        // TODO: test validations
    }
