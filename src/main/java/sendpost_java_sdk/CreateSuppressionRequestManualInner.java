...
public class CreateSuppressionRequestManualInner {
  public static final String SERIALIZED_NAME_EMAIL = "email";
  @SerializedName(SERIALIZED_NAME_EMAIL)
  @javax.annotation.Nullable
  private String email;

  public CreateSuppressionRequestManualInner() {
  }

  public CreateSuppressionRequestManualInner email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateSuppressionRequestManualInner createSuppressionRequestManualInner = (CreateSuppressionRequestManualInner) o;
    return Objects.equals(this.email, createSuppressionRequestManualInner.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSuppressionRequestManualInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSuppressionRequestManualInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSuppressionRequestManualInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSuppressionRequestManualInner is not found in the empty JSON string", CreateSuppressionRequestManualInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSuppressionRequestManualInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSuppressionRequestManualInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSuppressionRequestManualInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSuppressionRequestManualInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSuppressionRequestManualInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSuppressionRequestManualInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSuppressionRequestManualInner>() {
           @Override
           public void write(JsonWriter out, CreateSuppressionRequestManualInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSuppressionRequestManualInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSuppressionRequestManualInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSuppressionRequestManualInner
   * @throws IOException if the JSON string is invalid with respect to CreateSuppressionRequestManualInner
   */
  public static CreateSuppressionRequestManualInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSuppressionRequestManualInner.class);
  }

  /**
   * Convert an instance of CreateSuppressionRequestManualInner to an JSON string
   *
   * @return JSON string
   */
