...
public class DeleteSuppression200ResponseInner {
  ...
  public DeleteSuppression200ResponseInner() {
  }

  public DeleteSuppression200ResponseInner id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DeleteSuppression200ResponseInner message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSuppression200ResponseInner deleteSuppression200ResponseInner = (DeleteSuppression200ResponseInner) o;
    return Objects.equals(this.id, deleteSuppression200ResponseInner.id) &&
        Objects.equals(this.message, deleteSuppression200ResponseInner.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSuppression200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSuppression200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSuppression200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSuppression200ResponseInner is not found in the empty JSON string", DeleteSuppression200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSuppression200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSuppression200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSuppression200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSuppression200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSuppression200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSuppression200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSuppression200ResponseInner>() {
           @Override
           public void write(JsonWriter out, DeleteSuppression200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSuppression200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSuppression200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSuppression200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to DeleteSuppression200ResponseInner
   */
  public static DeleteSuppression200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSuppression200ResponseInner.class);
  }

  /**
   * Convert an instance of DeleteSuppression200ResponseInner to an JSON string
   *
   * @return JSON string
   */
