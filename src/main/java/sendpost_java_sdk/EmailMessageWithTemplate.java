...
public class EmailMessageWithTemplate {
  ...
  public EmailMessageWithTemplate from(@javax.annotation.Nullable EmailAddress from) {
    this.from = from;
    return this;
  }
  ...
  public EmailMessageWithTemplate to(@javax.annotation.Nullable List<Recipient> to) {
    this.to = to;
    return this;
  }

  public EmailMessageWithTemplate addToItem(Recipient toItem) {
    if (this.to == null) {
  ...
  public EmailMessageWithTemplate subject(@javax.annotation.Nullable String subject) {
  ...
  public EmailMessageWithTemplate textBody(@javax.annotation.Nullable String textBody) {
  ...
  public EmailMessageWithTemplate ippool(@javax.annotation.Nullable String ippool) {
    this.ippool = ippool;
    return this;
  }
  ...
  public EmailMessageWithTemplate headers(@javax.annotation.Nullable Map<String, String> headers) {
    this.headers = headers;
    return this;
  }

  public EmailMessageWithTemplate putHeadersItem(String key, String headersItem) {
  ...
  public EmailMessageWithTemplate trackOpens(@javax.annotation.Nullable Boolean trackOpens) {
  ...
  public EmailMessageWithTemplate trackClicks(@javax.annotation.Nullable Boolean trackClicks) {
  ...
  public EmailMessageWithTemplate groups(@javax.annotation.Nullable List<String> groups) {
    this.groups = groups;
    return this;
  }

  public EmailMessageWithTemplate addGroupsItem(String groupsItem) {
    if (this.groups == null) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(from, replyTo, to, subject, preText, htmlBody, textBody, ampBody, ippool, headers, trackOpens, trackClicks, groups, attachments, webhookEndpoint, template, templateId, templateVariables);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailMessageWithTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailMessageWithTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailMessageWithTemplate is not found in the empty JSON string", EmailMessageWithTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailMessageWithTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailMessageWithTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailMessageWithTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailMessageWithTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailMessageWithTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailMessageWithTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailMessageWithTemplate>() {
           @Override
           public void write(JsonWriter out, EmailMessageWithTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailMessageWithTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailMessageWithTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailMessageWithTemplate
   * @throws IOException if the JSON string is invalid with respect to EmailMessageWithTemplate
   */
  public static EmailMessageWithTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailMessageWithTemplate.class);
  }

  /**
   * Convert an instance of EmailMessageWithTemplate to an JSON string
   *
   * @return JSON string
   */
