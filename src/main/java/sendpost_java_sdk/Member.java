...
public class Member {
  ...
  public static final String SERIALIZED_NAME_ONBOARD_Q_ANSWERED = "onboardQAnswered";
  @SerializedName(SERIALIZED_NAME_ONBOARD_Q_ANSWERED)
  @javax.annotation.Nullable
  private Boolean onboardQAnswered;
  ...
  public Member id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Member isVerified(@javax.annotation.Nullable Boolean isVerified) {
  ...
  public Member isForbidden(@javax.annotation.Nullable Boolean isForbidden) {
  ...
  public Member name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Member companyName(@javax.annotation.Nullable String companyName) {
  ...
  public Member onboardQAnswered(@javax.annotation.Nullable Boolean onboardQAnswered) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getOnboardQAnswered() {
    return onboardQAnswered;
  }

  public void setOnboardQAnswered(@javax.annotation.Nullable Boolean onboardQAnswered) {
    this.onboardQAnswered = onboardQAnswered;
  }


  public Member phoneNumber(@javax.annotation.Nullable String phoneNumber) {
