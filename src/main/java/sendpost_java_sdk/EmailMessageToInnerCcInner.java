...
public class EmailMessageToInnerCcInner {
  ...
  public EmailMessageToInnerCcInner() {
  }

  public EmailMessageToInnerCcInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EmailMessageToInnerCcInner email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public EmailMessageToInnerCcInner customFields(@javax.annotation.Nullable Map<String, String> customFields) {
    this.customFields = customFields;
    return this;
  }

  public EmailMessageToInnerCcInner putCustomFieldsItem(String key, String customFieldsItem) {
  ...
  public boolean equals(Object o) {
    ...
    EmailMessageToInnerCcInner emailMessageToInnerCcInner = (EmailMessageToInnerCcInner) o;
    return Objects.equals(this.name, emailMessageToInnerCcInner.name) &&
        Objects.equals(this.email, emailMessageToInnerCcInner.email) &&
        Objects.equals(this.customFields, emailMessageToInnerCcInner.customFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailMessageToInnerCcInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailMessageToInnerCcInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailMessageToInnerCcInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailMessageToInnerCcInner is not found in the empty JSON string", EmailMessageToInnerCcInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailMessageToInnerCcInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailMessageToInnerCcInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailMessageToInnerCcInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailMessageToInnerCcInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailMessageToInnerCcInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailMessageToInnerCcInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailMessageToInnerCcInner>() {
           @Override
           public void write(JsonWriter out, EmailMessageToInnerCcInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailMessageToInnerCcInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailMessageToInnerCcInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailMessageToInnerCcInner
   * @throws IOException if the JSON string is invalid with respect to EmailMessageToInnerCcInner
   */
  public static EmailMessageToInnerCcInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailMessageToInnerCcInner.class);
  }

  /**
   * Convert an instance of EmailMessageToInnerCcInner to an JSON string
   *
   * @return JSON string
   */
