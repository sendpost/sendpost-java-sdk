...
public class SuppressionApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SuppressionApi() {
        this(Configuration.getDefaultApiClient());
    }

    public SuppressionApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createSuppression
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> A list of created suppressions </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createSuppressionCall(@javax.annotation.Nonnull CreateSuppressionRequest createSuppressionRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createSuppressionRequest;
    ...
    private okhttp3.Call createSuppressionValidateBeforeCall(@javax.annotation.Nonnull CreateSuppressionRequest createSuppressionRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'createSuppressionRequest' is set
        if (createSuppressionRequest == null) {
            throw new ApiException("Missing the required parameter 'createSuppressionRequest' when calling createSuppression(Async)");
        }

        return createSuppressionCall(createSuppressionRequest, _callback);
     ...
     */
    public List<Suppression> createSuppression(@javax.annotation.Nonnull CreateSuppressionRequest createSuppressionRequest) throws ApiException {
        ApiResponse<List<Suppression>> localVarResp = createSuppressionWithHttpInfo(createSuppressionRequest);
     ...
     */
    public ApiResponse<List<Suppression>> createSuppressionWithHttpInfo(@javax.annotation.Nonnull CreateSuppressionRequest createSuppressionRequest) throws ApiException {
        okhttp3.Call localVarCall = createSuppressionValidateBeforeCall(createSuppressionRequest, null);
     ...
     */
    public okhttp3.Call createSuppressionAsync(@javax.annotation.Nonnull CreateSuppressionRequest createSuppressionRequest, final ApiCallback<List<Suppression>> _callback) throws ApiException {

        okhttp3.Call localVarCall = createSuppressionValidateBeforeCall(createSuppressionRequest, _callback);
        Type localVarReturnType = new TypeToken<List<Suppression>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteSuppression
     ...
     */
    public okhttp3.Call deleteSuppressionCall(@javax.annotation.Nonnull DeleteSuppressionRequest deleteSuppressionRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = deleteSuppressionRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteSuppressionValidateBeforeCall(@javax.annotation.Nonnull DeleteSuppressionRequest deleteSuppressionRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'deleteSuppressionRequest' is set
        if (deleteSuppressionRequest == null) {
            throw new ApiException("Missing the required parameter 'deleteSuppressionRequest' when calling deleteSuppression(Async)");
        }

        return deleteSuppressionCall(deleteSuppressionRequest, _callback);
    ...
    /**
     * Build call for getSuppressionList
     ...
     * @param limit Number of records to return per request (optional, default to 20)
     * @param offset Number of initial records to skip (optional, default to 0)
     * @param search Case-insensitive search against suppression email (optional)
     * @param type Type of suppression. Valid values: &#x60;hardBounce&#x60;, &#x60;manual&#x60;, &#x60;spamComplaint&#x60;, &#x60;unsubscribe&#x60;  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A list of suppressions </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getSuppressionListCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, @javax.annotation.Nullable String type, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSuppressionListValidateBeforeCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, @javax.annotation.Nullable String type, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getSuppressionList(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getSuppressionList(Async)");
        }

        return getSuppressionListCall(from, to, limit, offset, search, type, _callback);
     ...
     */
    public List<Suppression> getSuppressionList(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, @javax.annotation.Nullable String type) throws ApiException {
        ApiResponse<List<Suppression>> localVarResp = getSuppressionListWithHttpInfo(from, to, limit, offset, search, type);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Suppression>> getSuppressionListWithHttpInfo(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, @javax.annotation.Nullable String type) throws ApiException {
        okhttp3.Call localVarCall = getSuppressionListValidateBeforeCall(from, to, limit, offset, search, type, null);
        Type localVarReturnType = new TypeToken<List<Suppression>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getSuppressionListAsync(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, @javax.annotation.Nullable String type, final ApiCallback<List<Suppression>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSuppressionListValidateBeforeCall(from, to, limit, offset, search, type, _callback);
        Type localVarReturnType = new TypeToken<List<Suppression>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
