...
import sendpost_java_sdk.CreateDomainRequest;
import sendpost_java_sdk.DeleteResponse;
...
public class DomainApi {
     ...
     * @param search Case insensitive search against domain names (optional)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> List of domains retrieved successfully </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAllDomainsCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        ...
        String[] localVarAuthNames = new String[] { "subAccountAuth" };
        return localVarApiClient.buildCall(basePath, localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAuthNames, _callback);
    }

    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllDomainsValidateBeforeCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        return getAllDomainsCall(limit, offset, search, _callback);
     ...
     */
    public List<Domain> getAllDomains(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search) throws ApiException {
        ApiResponse<List<Domain>> localVarResp = getAllDomainsWithHttpInfo(limit, offset, search);
     ...
     */
    public ApiResponse<List<Domain>> getAllDomainsWithHttpInfo(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search) throws ApiException {
        okhttp3.Call localVarCall = getAllDomainsValidateBeforeCall(limit, offset, search, null);
     ...
     */
    public okhttp3.Call getAllDomainsAsync(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback<List<Domain>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllDomainsValidateBeforeCall(limit, offset, search, _callback);
        Type localVarReturnType = new TypeToken<List<Domain>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for subaccountDomainDomainIdDelete
     ...
     */
    public okhttp3.Call subaccountDomainDomainIdDeleteCall(@javax.annotation.Nonnull String domainId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subaccount/domain/{domain_id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call subaccountDomainDomainIdDeleteValidateBeforeCall(@javax.annotation.Nonnull String domainId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domainId' is set
        if (domainId == null) {
            throw new ApiException("Missing the required parameter 'domainId' when calling subaccountDomainDomainIdDelete(Async)");
        }

        return subaccountDomainDomainIdDeleteCall(domainId, _callback);
     ...
     */
    public DeleteResponse subaccountDomainDomainIdDelete(@javax.annotation.Nonnull String domainId) throws ApiException {
        ApiResponse<DeleteResponse> localVarResp = subaccountDomainDomainIdDeleteWithHttpInfo(domainId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeleteResponse> subaccountDomainDomainIdDeleteWithHttpInfo(@javax.annotation.Nonnull String domainId) throws ApiException {
        okhttp3.Call localVarCall = subaccountDomainDomainIdDeleteValidateBeforeCall(domainId, null);
     ...
     */
    public okhttp3.Call subaccountDomainDomainIdDeleteAsync(@javax.annotation.Nonnull String domainId, final ApiCallback<DeleteResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = subaccountDomainDomainIdDeleteValidateBeforeCall(domainId, _callback);
        Type localVarReturnType = new TypeToken<DeleteResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for subaccountDomainDomainIdGet
     ...
     */
    public okhttp3.Call subaccountDomainDomainIdGetCall(@javax.annotation.Nonnull String domainId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call subaccountDomainDomainIdGetValidateBeforeCall(@javax.annotation.Nonnull String domainId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domainId' is set
        if (domainId == null) {
            throw new ApiException("Missing the required parameter 'domainId' when calling subaccountDomainDomainIdGet(Async)");
        }

        return subaccountDomainDomainIdGetCall(domainId, _callback);
     ...
     */
    public Domain subaccountDomainDomainIdGet(@javax.annotation.Nonnull String domainId) throws ApiException {
        ApiResponse<Domain> localVarResp = subaccountDomainDomainIdGetWithHttpInfo(domainId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Domain> subaccountDomainDomainIdGetWithHttpInfo(@javax.annotation.Nonnull String domainId) throws ApiException {
        okhttp3.Call localVarCall = subaccountDomainDomainIdGetValidateBeforeCall(domainId, null);
     ...
     */
    public okhttp3.Call subaccountDomainDomainIdGetAsync(@javax.annotation.Nonnull String domainId, final ApiCallback<Domain> _callback) throws ApiException {

        okhttp3.Call localVarCall = subaccountDomainDomainIdGetValidateBeforeCall(domainId, _callback);
        Type localVarReturnType = new TypeToken<Domain>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for subaccountDomainPost
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call subaccountDomainPostValidateBeforeCall(@javax.annotation.Nonnull CreateDomainRequest createDomainRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'createDomainRequest' is set
        if (createDomainRequest == null) {
            throw new ApiException("Missing the required parameter 'createDomainRequest' when calling subaccountDomainPost(Async)");
        }

        return subaccountDomainPostCall(createDomainRequest, _callback);
    ...
    public Domain subaccountDomainPost(@javax.annotation.Nonnull CreateDomainRequest createDomainRequest) throws ApiException {
        ApiResponse<Domain> localVarResp = subaccountDomainPostWithHttpInfo(createDomainRequest);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Domain> subaccountDomainPostWithHttpInfo(@javax.annotation.Nonnull CreateDomainRequest createDomainRequest) throws ApiException {
        okhttp3.Call localVarCall = subaccountDomainPostValidateBeforeCall(createDomainRequest, null);
        Type localVarReturnType = new TypeToken<Domain>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call subaccountDomainPostAsync(@javax.annotation.Nonnull CreateDomainRequest createDomainRequest, final ApiCallback<Domain> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = subaccountDomainPostValidateBeforeCall(createDomainRequest, _callback);
        Type localVarReturnType = new TypeToken<Domain>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
