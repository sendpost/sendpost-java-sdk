...
public class Domain {
  ...
  @javax.annotation.Nullable
  private DomainReturnPath returnPath;

  public static final String SERIALIZED_NAME_TRACK = "track";
  @SerializedName(SERIALIZED_NAME_TRACK)
  @javax.annotation.Nullable
  private DomainTrack track;

  public static final String SERIALIZED_NAME_DMARC = "dmarc";
  @SerializedName(SERIALIZED_NAME_DMARC)
  @javax.annotation.Nullable
  private DomainDmarc dmarc;

  public static final String SERIALIZED_NAME_DKIM_CONFIG = "dkimConfig";
  @SerializedName(SERIALIZED_NAME_DKIM_CONFIG)
  @javax.annotation.Nullable
  private String dkimConfig;

  public static final String SERIALIZED_NAME_DKIM_VERIFIED = "dkimVerified";
  ...
  public static final String SERIALIZED_NAME_RETURN_PATH_VERIFIED = "returnPathVerified";
  @SerializedName(SERIALIZED_NAME_RETURN_PATH_VERIFIED)
  @javax.annotation.Nullable
  private Boolean returnPathVerified;

  public static final String SERIALIZED_NAME_TRACK_VERIFIED = "trackVerified";
  ...
  public Domain id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Domain dkim(@javax.annotation.Nullable DomainDkim dkim) {
    this.dkim = dkim;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DomainDkim getDkim() {
    return dkim;
  }

  public void setDkim(@javax.annotation.Nullable DomainDkim dkim) {
    this.dkim = dkim;
  }
   ...
   */
  @javax.annotation.Nullable
  public DomainReturnPath getReturnPath() {
    return returnPath;
  }

  public void setReturnPath(@javax.annotation.Nullable DomainReturnPath returnPath) {
    this.returnPath = returnPath;
  }


  public Domain track(@javax.annotation.Nullable DomainTrack track) {
    this.track = track;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DomainTrack getTrack() {
    return track;
  }

  public void setTrack(@javax.annotation.Nullable DomainTrack track) {
    this.track = track;
  }


  public Domain dmarc(@javax.annotation.Nullable DomainDmarc dmarc) {
    this.dmarc = dmarc;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DomainDmarc getDmarc() {
    return dmarc;
  }

  public void setDmarc(@javax.annotation.Nullable DomainDmarc dmarc) {
    this.dmarc = dmarc;
  }


  public Domain dkimConfig(@javax.annotation.Nullable String dkimConfig) {
  ...
  public void setDkimConfig(@javax.annotation.Nullable String dkimConfig) {
    this.dkimConfig = dkimConfig;
  }


  public Domain dkimVerified(@javax.annotation.Nullable Boolean dkimVerified) {
  ...
  public Domain dmarcVerified(@javax.annotation.Nullable Boolean dmarcVerified) {
  ...
  public void setDmarcVerified(@javax.annotation.Nullable Boolean dmarcVerified) {
    this.dmarcVerified = dmarcVerified;
  }


  public Domain returnPathVerified(@javax.annotation.Nullable Boolean returnPathVerified) {
  ...
  public void setReturnPathVerified(@javax.annotation.Nullable Boolean returnPathVerified) {
    this.returnPathVerified = returnPathVerified;
  }


  public Domain trackVerified(@javax.annotation.Nullable Boolean trackVerified) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getTrackVerified() {
    return trackVerified;
  }

  public void setTrackVerified(@javax.annotation.Nullable Boolean trackVerified) {
    this.trackVerified = trackVerified;
  }
