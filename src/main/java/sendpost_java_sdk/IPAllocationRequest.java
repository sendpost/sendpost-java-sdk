...
public class IPAllocationRequest {
  ...
  public IPAllocationRequest() {
  }

  public IPAllocationRequest overflowPool(@javax.annotation.Nonnull Boolean overflowPool) {
  ...
  public void setOverflowPool(@javax.annotation.Nonnull Boolean overflowPool) {
    this.overflowPool = overflowPool;
  }


  public IPAllocationRequest ips(@javax.annotation.Nonnull List<String> ips) {
    this.ips = ips;
    return this;
  }

  public IPAllocationRequest addIpsItem(String ipsItem) {
    if (this.ips == null) {
  ...
  public boolean equals(Object o) {
    ...
    IPAllocationRequest ipAllocationRequest = (IPAllocationRequest) o;
    return Objects.equals(this.overflowPool, ipAllocationRequest.overflowPool) &&
        Objects.equals(this.ips, ipAllocationRequest.ips);
  }

  @Override
  public int hashCode() {
    return Objects.hash(overflowPool, ips);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IPAllocationRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("overflowPool");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPAllocationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAllocationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPAllocationRequest is not found in the empty JSON string", IPAllocationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPAllocationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPAllocationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IPAllocationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAllocationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAllocationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAllocationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAllocationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAllocationRequest>() {
           @Override
           public void write(JsonWriter out, IPAllocationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPAllocationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPAllocationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPAllocationRequest
   * @throws IOException if the JSON string is invalid with respect to IPAllocationRequest
   */
  public static IPAllocationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAllocationRequest.class);
  }

  /**
   * Convert an instance of IPAllocationRequest to an JSON string
   *
   * @return JSON string
   */
