...
public class EmailMessageReplyTo {
  ...
  public EmailMessageReplyTo name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EmailMessageReplyTo email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailMessageReplyTo emailMessageReplyTo = (EmailMessageReplyTo) o;
    return Objects.equals(this.name, emailMessageReplyTo.name) &&
        Objects.equals(this.email, emailMessageReplyTo.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailMessageReplyTo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailMessageReplyTo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailMessageReplyTo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailMessageReplyTo is not found in the empty JSON string", EmailMessageReplyTo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailMessageReplyTo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailMessageReplyTo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailMessageReplyTo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailMessageReplyTo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailMessageReplyTo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailMessageReplyTo.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailMessageReplyTo>() {
           @Override
           public void write(JsonWriter out, EmailMessageReplyTo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailMessageReplyTo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailMessageReplyTo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailMessageReplyTo
   * @throws IOException if the JSON string is invalid with respect to EmailMessageReplyTo
   */
  public static EmailMessageReplyTo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailMessageReplyTo.class);
  }

  /**
   * Convert an instance of EmailMessageReplyTo to an JSON string
   *
   * @return JSON string
   */
