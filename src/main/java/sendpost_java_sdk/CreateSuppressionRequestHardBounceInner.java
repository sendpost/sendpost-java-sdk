...
public class CreateSuppressionRequestHardBounceInner {
  public static final String SERIALIZED_NAME_EMAIL = "email";
  @SerializedName(SERIALIZED_NAME_EMAIL)
  @javax.annotation.Nullable
  private String email;

  public CreateSuppressionRequestHardBounceInner() {
  }

  public CreateSuppressionRequestHardBounceInner email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateSuppressionRequestHardBounceInner createSuppressionRequestHardBounceInner = (CreateSuppressionRequestHardBounceInner) o;
    return Objects.equals(this.email, createSuppressionRequestHardBounceInner.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSuppressionRequestHardBounceInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSuppressionRequestHardBounceInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSuppressionRequestHardBounceInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSuppressionRequestHardBounceInner is not found in the empty JSON string", CreateSuppressionRequestHardBounceInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSuppressionRequestHardBounceInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSuppressionRequestHardBounceInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSuppressionRequestHardBounceInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSuppressionRequestHardBounceInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSuppressionRequestHardBounceInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSuppressionRequestHardBounceInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSuppressionRequestHardBounceInner>() {
           @Override
           public void write(JsonWriter out, CreateSuppressionRequestHardBounceInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSuppressionRequestHardBounceInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSuppressionRequestHardBounceInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSuppressionRequestHardBounceInner
   * @throws IOException if the JSON string is invalid with respect to CreateSuppressionRequestHardBounceInner
   */
  public static CreateSuppressionRequestHardBounceInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSuppressionRequestHardBounceInner.class);
  }

  /**
   * Convert an instance of CreateSuppressionRequestHardBounceInner to an JSON string
   *
   * @return JSON string
   */
