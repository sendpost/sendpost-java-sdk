...
import sendpost_java_sdk.EmailMessageToInnerBccInner;
import sendpost_java_sdk.EmailMessageToInnerCcInner;
...
public class EmailMessageToInner {
  ...
  @javax.annotation.Nullable
  private List<EmailMessageToInnerCcInner> cc = new ArrayList<>();

  public static final String SERIALIZED_NAME_BCC = "bcc";
  @SerializedName(SERIALIZED_NAME_BCC)
  @javax.annotation.Nullable
  private List<EmailMessageToInnerBccInner> bcc = new ArrayList<>();

  public EmailMessageToInner() {
  }

  public EmailMessageToInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EmailMessageToInner email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public EmailMessageToInner customFields(@javax.annotation.Nullable Map<String, String> customFields) {
    this.customFields = customFields;
    return this;
  }

  public EmailMessageToInner putCustomFieldsItem(String key, String customFieldsItem) {
  ...
  public EmailMessageToInner cc(@javax.annotation.Nullable List<EmailMessageToInnerCcInner> cc) {
    this.cc = cc;
    return this;
  }

  public EmailMessageToInner addCcItem(EmailMessageToInnerCcInner ccItem) {
    if (this.cc == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<EmailMessageToInnerCcInner> getCc() {
    return cc;
  }

  public void setCc(@javax.annotation.Nullable List<EmailMessageToInnerCcInner> cc) {
    this.cc = cc;
  }


  public EmailMessageToInner bcc(@javax.annotation.Nullable List<EmailMessageToInnerBccInner> bcc) {
    this.bcc = bcc;
    return this;
  }

  public EmailMessageToInner addBccItem(EmailMessageToInnerBccInner bccItem) {
    if (this.bcc == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<EmailMessageToInnerBccInner> getBcc() {
    return bcc;
  }

  public void setBcc(@javax.annotation.Nullable List<EmailMessageToInnerBccInner> bcc) {
    this.bcc = bcc;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailMessageToInner emailMessageToInner = (EmailMessageToInner) o;
    return Objects.equals(this.name, emailMessageToInner.name) &&
        Objects.equals(this.email, emailMessageToInner.email) &&
        Objects.equals(this.customFields, emailMessageToInner.customFields) &&
        Objects.equals(this.cc, emailMessageToInner.cc) &&
        Objects.equals(this.bcc, emailMessageToInner.bcc);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, email, customFields, cc, bcc);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailMessageToInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailMessageToInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailMessageToInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailMessageToInner is not found in the empty JSON string", EmailMessageToInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailMessageToInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailMessageToInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("cc") != null && !jsonObj.get("cc").isJsonNull()) {
        ...
        if (jsonArraycc != null) {
          ...
          for (int i = 0; i < jsonArraycc.size(); i++) {
            EmailMessageToInnerCcInner.validateJsonElement(jsonArraycc.get(i));
          };
        }
      }
      if (jsonObj.get("bcc") != null && !jsonObj.get("bcc").isJsonNull()) {
        ...
        if (jsonArraybcc != null) {
          ...
          for (int i = 0; i < jsonArraybcc.size(); i++) {
            EmailMessageToInnerBccInner.validateJsonElement(jsonArraybcc.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailMessageToInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailMessageToInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailMessageToInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailMessageToInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailMessageToInner>() {
           @Override
           public void write(JsonWriter out, EmailMessageToInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailMessageToInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailMessageToInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailMessageToInner
   * @throws IOException if the JSON string is invalid with respect to EmailMessageToInner
   */
  public static EmailMessageToInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailMessageToInner.class);
  }

  /**
   * Convert an instance of EmailMessageToInner to an JSON string
   *
   * @return JSON string
   */
