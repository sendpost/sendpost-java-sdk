...
public class AggregatedEmailStats {
  ...
  public AggregatedEmailStats() {
  }

  public AggregatedEmailStats processed(@javax.annotation.Nullable Integer processed) {
  ...
  public AggregatedEmailStats sent(@javax.annotation.Nullable Integer sent) {
    this.sent = sent;
    return this;
  }
  ...
  public AggregatedEmailStats delivered(@javax.annotation.Nullable Integer delivered) {
  ...
  public AggregatedEmailStats dropped(@javax.annotation.Nullable Integer dropped) {
  ...
  public AggregatedEmailStats smtpDropped(@javax.annotation.Nullable Integer smtpDropped) {
  ...
  public AggregatedEmailStats hardBounced(@javax.annotation.Nullable Integer hardBounced) {
  ...
  public AggregatedEmailStats softBounced(@javax.annotation.Nullable Integer softBounced) {
  ...
  public AggregatedEmailStats opened(@javax.annotation.Nullable Integer opened) {
    this.opened = opened;
    return this;
  }
  ...
  public AggregatedEmailStats clicked(@javax.annotation.Nullable Integer clicked) {
  ...
  public AggregatedEmailStats unsubscribed(@javax.annotation.Nullable Integer unsubscribed) {
  ...
  public AggregatedEmailStats spam(@javax.annotation.Nullable Integer spam) {
    this.spam = spam;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AggregatedEmailStats aggregatedEmailStats = (AggregatedEmailStats) o;
    return Objects.equals(this.processed, aggregatedEmailStats.processed) &&
        Objects.equals(this.sent, aggregatedEmailStats.sent) &&
        Objects.equals(this.delivered, aggregatedEmailStats.delivered) &&
        Objects.equals(this.dropped, aggregatedEmailStats.dropped) &&
        Objects.equals(this.smtpDropped, aggregatedEmailStats.smtpDropped) &&
        Objects.equals(this.hardBounced, aggregatedEmailStats.hardBounced) &&
        Objects.equals(this.softBounced, aggregatedEmailStats.softBounced) &&
        Objects.equals(this.opened, aggregatedEmailStats.opened) &&
        Objects.equals(this.clicked, aggregatedEmailStats.clicked) &&
        Objects.equals(this.unsubscribed, aggregatedEmailStats.unsubscribed) &&
        Objects.equals(this.spam, aggregatedEmailStats.spam);
  }
  ...
  public String toString() {
    ...
    sb.append("class AggregatedEmailStats {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AggregatedEmailStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregatedEmailStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregatedEmailStats is not found in the empty JSON string", AggregatedEmailStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AggregatedEmailStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AggregatedEmailStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregatedEmailStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregatedEmailStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregatedEmailStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregatedEmailStats.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregatedEmailStats>() {
           @Override
           public void write(JsonWriter out, AggregatedEmailStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AggregatedEmailStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AggregatedEmailStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AggregatedEmailStats
   * @throws IOException if the JSON string is invalid with respect to AggregatedEmailStats
   */
  public static AggregatedEmailStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregatedEmailStats.class);
  }

  /**
   * Convert an instance of AggregatedEmailStats to an JSON string
   *
   * @return JSON string
   */
