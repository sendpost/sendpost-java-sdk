...
public class WebhookApi {
     ...
     */
    public okhttp3.Call deleteWebhookCall(@javax.annotation.Nonnull Integer webhookId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/account/webhook/{webhook_id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteWebhookValidateBeforeCall(@javax.annotation.Nonnull Integer webhookId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public DeleteWebhookResponse deleteWebhook(@javax.annotation.Nonnull Integer webhookId) throws ApiException {
        ApiResponse<DeleteWebhookResponse> localVarResp = deleteWebhookWithHttpInfo(webhookId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeleteWebhookResponse> deleteWebhookWithHttpInfo(@javax.annotation.Nonnull Integer webhookId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteWebhookAsync(@javax.annotation.Nonnull Integer webhookId, final ApiCallback<DeleteWebhookResponse> _callback) throws ApiException {
     ...
     * @param search Case insensitive search against webhook URL. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getAllWebhooksCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllWebhooksValidateBeforeCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        return getAllWebhooksCall(limit, offset, search, _callback);
     ...
     */
    public List<Webhook> getAllWebhooks(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search) throws ApiException {
        ApiResponse<List<Webhook>> localVarResp = getAllWebhooksWithHttpInfo(limit, offset, search);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Webhook>> getAllWebhooksWithHttpInfo(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search) throws ApiException {
        okhttp3.Call localVarCall = getAllWebhooksValidateBeforeCall(limit, offset, search, null);
     ...
     */
    public okhttp3.Call getAllWebhooksAsync(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback<List<Webhook>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllWebhooksValidateBeforeCall(limit, offset, search, _callback);
        Type localVarReturnType = new TypeToken<List<Webhook>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getWebhookCall(@javax.annotation.Nonnull Integer webhookId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWebhookValidateBeforeCall(@javax.annotation.Nonnull Integer webhookId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'webhookId' is set
        if (webhookId == null) {
     ...
     */
    public Webhook getWebhook(@javax.annotation.Nonnull Integer webhookId) throws ApiException {
     ...
     */
    public ApiResponse<Webhook> getWebhookWithHttpInfo(@javax.annotation.Nonnull Integer webhookId) throws ApiException {
     ...
     */
    public okhttp3.Call getWebhookAsync(@javax.annotation.Nonnull Integer webhookId, final ApiCallback<Webhook> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateWebhookCall(@javax.annotation.Nonnull Integer webhookId, @javax.annotation.Nonnull UpdateWebhook updateWebhook, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateWebhookValidateBeforeCall(@javax.annotation.Nonnull Integer webhookId, @javax.annotation.Nonnull UpdateWebhook updateWebhook, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'webhookId' is set
        if (webhookId == null) {
        ...
        return updateWebhookCall(webhookId, updateWebhook, _callback);
     ...
     */
    public Webhook updateWebhook(@javax.annotation.Nonnull Integer webhookId, @javax.annotation.Nonnull UpdateWebhook updateWebhook) throws ApiException {
        ApiResponse<Webhook> localVarResp = updateWebhookWithHttpInfo(webhookId, updateWebhook);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Webhook> updateWebhookWithHttpInfo(@javax.annotation.Nonnull Integer webhookId, @javax.annotation.Nonnull UpdateWebhook updateWebhook) throws ApiException {
        okhttp3.Call localVarCall = updateWebhookValidateBeforeCall(webhookId, updateWebhook, null);
        Type localVarReturnType = new TypeToken<Webhook>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateWebhookAsync(@javax.annotation.Nonnull Integer webhookId, @javax.annotation.Nonnull UpdateWebhook updateWebhook, final ApiCallback<Webhook> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateWebhookValidateBeforeCall(webhookId, updateWebhook, _callback);
        Type localVarReturnType = new TypeToken<Webhook>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
