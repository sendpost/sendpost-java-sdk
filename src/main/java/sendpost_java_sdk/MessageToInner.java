...
public class MessageToInner {
  ...
  public MessageToInner() {
  }

  public MessageToInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MessageToInner email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public MessageToInner customFields(@javax.annotation.Nullable Map<String, String> customFields) {
    this.customFields = customFields;
    return this;
  }

  public MessageToInner putCustomFieldsItem(String key, String customFieldsItem) {
  ...
  public boolean equals(Object o) {
    ...
    MessageToInner messageToInner = (MessageToInner) o;
    return Objects.equals(this.name, messageToInner.name) &&
        Objects.equals(this.email, messageToInner.email) &&
        Objects.equals(this.customFields, messageToInner.customFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessageToInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageToInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageToInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageToInner is not found in the empty JSON string", MessageToInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageToInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageToInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageToInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageToInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageToInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageToInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageToInner>() {
           @Override
           public void write(JsonWriter out, MessageToInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageToInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageToInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageToInner
   * @throws IOException if the JSON string is invalid with respect to MessageToInner
   */
  public static MessageToInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageToInner.class);
  }

  /**
   * Convert an instance of MessageToInner to an JSON string
   *
   * @return JSON string
   */
