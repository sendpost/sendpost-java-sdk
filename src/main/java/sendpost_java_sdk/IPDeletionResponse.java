...
public class IPDeletionResponse {
  ...
  public IPDeletionResponse() {
  }

  public IPDeletionResponse id(@javax.annotation.Nonnull Integer id) {
    this.id = id;
    return this;
  }
  ...
  public IPDeletionResponse message(@javax.annotation.Nonnull String message) {
  ...
  public boolean equals(Object o) {
    ...
    IPDeletionResponse ipDeletionResponse = (IPDeletionResponse) o;
    return Objects.equals(this.id, ipDeletionResponse.id) &&
        Objects.equals(this.message, ipDeletionResponse.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPDeletionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPDeletionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPDeletionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPDeletionResponse is not found in the empty JSON string", IPDeletionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPDeletionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPDeletionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IPDeletionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPDeletionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPDeletionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPDeletionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPDeletionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IPDeletionResponse>() {
           @Override
           public void write(JsonWriter out, IPDeletionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPDeletionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPDeletionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPDeletionResponse
   * @throws IOException if the JSON string is invalid with respect to IPDeletionResponse
   */
  public static IPDeletionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPDeletionResponse.class);
  }

  /**
   * Convert an instance of IPDeletionResponse to an JSON string
   *
   * @return JSON string
   */
