...
import sendpost_java_sdk.EmailMessage;
import sendpost_java_sdk.Event;
 ...
 * WebhookObject
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-12-24T13:38:59.630186+05:30[Asia/Kolkata]", comments = "Generator version: 7.13.0")
public class WebhookObject {
  ...
  public WebhookObject event(@javax.annotation.Nullable Event event) {
    this.event = event;
    return this;
  }
  ...
  public WebhookObject emailMessage(@javax.annotation.Nullable EmailMessage emailMessage) {
  ...
  public void setEmailMessage(@javax.annotation.Nullable EmailMessage emailMessage) {
    this.emailMessage = emailMessage;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.event, webhookObject.event) &&
        Objects.equals(this.emailMessage, webhookObject.emailMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(event, emailMessage);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("emailMessage") != null && !jsonObj.get("emailMessage").isJsonNull()) {
        EmailMessage.validateJsonElement(jsonObj.get("emailMessage"));
      }
  }
