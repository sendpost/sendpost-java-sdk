...
import sendpost_java_sdk.EmailMessageFrom;
import sendpost_java_sdk.EmailMessageReplyTo;
import sendpost_java_sdk.EmailMessageToInner;
...
public class EmailMessage {
  ...
  @javax.annotation.Nullable
  private EmailMessageFrom from;

  public static final String SERIALIZED_NAME_REPLY_TO = "replyTo";
  @SerializedName(SERIALIZED_NAME_REPLY_TO)
  @javax.annotation.Nullable
  private EmailMessageReplyTo replyTo;

  public static final String SERIALIZED_NAME_TO = "to";
  @SerializedName(SERIALIZED_NAME_TO)
  @javax.annotation.Nullable
  private List<EmailMessageToInner> to = new ArrayList<>();
  ...
  public EmailMessage messageID(@javax.annotation.Nullable String messageID) {
  ...
  public EmailMessage accountID(@javax.annotation.Nullable Integer accountID) {
  ...
  public EmailMessage subAccountID(@javax.annotation.Nullable Integer subAccountID) {
  ...
  public EmailMessage ipID(@javax.annotation.Nullable Integer ipID) {
    this.ipID = ipID;
    return this;
  }
  ...
  public EmailMessage publicIP(@javax.annotation.Nullable String publicIP) {
  ...
  public EmailMessage localIP(@javax.annotation.Nullable String localIP) {
  ...
  public EmailMessage emailType(@javax.annotation.Nullable String emailType) {
  ...
  public EmailMessage submittedAt(@javax.annotation.Nullable Integer submittedAt) {
  ...
  public EmailMessage from(@javax.annotation.Nullable EmailMessageFrom from) {
    this.from = from;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public EmailMessageFrom getFrom() {
    return from;
  }

  public void setFrom(@javax.annotation.Nullable EmailMessageFrom from) {
    this.from = from;
  }


  public EmailMessage replyTo(@javax.annotation.Nullable EmailMessageReplyTo replyTo) {
   ...
   */
  @javax.annotation.Nullable
  public EmailMessageReplyTo getReplyTo() {
    return replyTo;
  }

  public void setReplyTo(@javax.annotation.Nullable EmailMessageReplyTo replyTo) {
    this.replyTo = replyTo;
  }


  public EmailMessage to(@javax.annotation.Nullable List<EmailMessageToInner> to) {
    this.to = to;
    return this;
  }

  public EmailMessage addToItem(EmailMessageToInner toItem) {
    if (this.to == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<EmailMessageToInner> getTo() {
    return to;
  }

  public void setTo(@javax.annotation.Nullable List<EmailMessageToInner> to) {
    this.to = to;
  }


  public EmailMessage groups(@javax.annotation.Nullable List<String> groups) {
    this.groups = groups;
    return this;
  }

  public EmailMessage addGroupsItem(String groupsItem) {
    if (this.groups == null) {
  ...
  public EmailMessage ipPool(@javax.annotation.Nullable String ipPool) {
    this.ipPool = ipPool;
    return this;
  }
  ...
  public EmailMessage headers(@javax.annotation.Nullable Map<String, String> headers) {
    this.headers = headers;
    return this;
  }

  public EmailMessage putHeadersItem(String key, String headersItem) {
  ...
  public EmailMessage customFields(@javax.annotation.Nullable Map<String, String> customFields) {
    this.customFields = customFields;
    return this;
  }

  public EmailMessage putCustomFieldsItem(String key, String customFieldsItem) {
  ...
  public EmailMessage trackOpens(@javax.annotation.Nullable Boolean trackOpens) {
  ...
  public EmailMessage trackClicks(@javax.annotation.Nullable Boolean trackClicks) {
  ...
  public EmailMessage webhookEndpoint(@javax.annotation.Nullable String webhookEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.messageID, emailMessage.messageID) &&
        Objects.equals(this.accountID, emailMessage.accountID) &&
        Objects.equals(this.subAccountID, emailMessage.subAccountID) &&
        Objects.equals(this.ipID, emailMessage.ipID) &&
        Objects.equals(this.publicIP, emailMessage.publicIP) &&
        Objects.equals(this.localIP, emailMessage.localIP) &&
        Objects.equals(this.emailType, emailMessage.emailType) &&
        Objects.equals(this.submittedAt, emailMessage.submittedAt) &&
        ...
        Objects.equals(this.groups, emailMessage.groups) &&
        Objects.equals(this.ipPool, emailMessage.ipPool) &&
        Objects.equals(this.headers, emailMessage.headers) &&
        Objects.equals(this.customFields, emailMessage.customFields) &&
        Objects.equals(this.trackOpens, emailMessage.trackOpens) &&
        Objects.equals(this.trackClicks, emailMessage.trackClicks) &&
        Objects.equals(this.webhookEndpoint, emailMessage.webhookEndpoint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(messageID, accountID, subAccountID, ipID, publicIP, localIP, emailType, submittedAt, from, replyTo, to, groups, ipPool, headers, customFields, trackOpens, trackClicks, webhookEndpoint);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailMessage is not found in the empty JSON string", EmailMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("from") != null && !jsonObj.get("from").isJsonNull()) {
        EmailMessageFrom.validateJsonElement(jsonObj.get("from"));
      }
      // validate the optional field `replyTo`
      if (jsonObj.get("replyTo") != null && !jsonObj.get("replyTo").isJsonNull()) {
        EmailMessageReplyTo.validateJsonElement(jsonObj.get("replyTo"));
      }
      if (jsonObj.get("to") != null && !jsonObj.get("to").isJsonNull()) {
        ...
        if (jsonArrayto != null) {
          ...
          for (int i = 0; i < jsonArrayto.size(); i++) {
            EmailMessageToInner.validateJsonElement(jsonArrayto.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailMessage>() {
           @Override
           public void write(JsonWriter out, EmailMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailMessage
   * @throws IOException if the JSON string is invalid with respect to EmailMessage
   */
  public static EmailMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailMessage.class);
  }

  /**
   * Convert an instance of EmailMessage to an JSON string
   *
   * @return JSON string
   */
