...
public class DeleteSuppressionRequest {
  ...
  private List<CreateSuppressionRequestSpamComplaintInner> suppressions = new ArrayList<>();

  public DeleteSuppressionRequest() {
  }

  public DeleteSuppressionRequest suppressions(@javax.annotation.Nullable List<CreateSuppressionRequestSpamComplaintInner> suppressions) {
    this.suppressions = suppressions;
    return this;
  }

  public DeleteSuppressionRequest addSuppressionsItem(CreateSuppressionRequestSpamComplaintInner suppressionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<CreateSuppressionRequestSpamComplaintInner> getSuppressions() {
    return suppressions;
  }

  public void setSuppressions(@javax.annotation.Nullable List<CreateSuppressionRequestSpamComplaintInner> suppressions) {
    this.suppressions = suppressions;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteSuppressionRequest deleteSuppressionRequest = (DeleteSuppressionRequest) o;
    return Objects.equals(this.suppressions, deleteSuppressionRequest.suppressions);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSuppressionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSuppressionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSuppressionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSuppressionRequest is not found in the empty JSON string", DeleteSuppressionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSuppressionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSuppressionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("suppressions") != null && !jsonObj.get("suppressions").isJsonNull()) {
        JsonArray jsonArraysuppressions = jsonObj.getAsJsonArray("suppressions");
        if (jsonArraysuppressions != null) {
          ...
          for (int i = 0; i < jsonArraysuppressions.size(); i++) {
            CreateSuppressionRequestSpamComplaintInner.validateJsonElement(jsonArraysuppressions.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSuppressionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSuppressionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSuppressionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSuppressionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSuppressionRequest>() {
           @Override
           public void write(JsonWriter out, DeleteSuppressionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSuppressionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSuppressionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSuppressionRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteSuppressionRequest
   */
  public static DeleteSuppressionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSuppressionRequest.class);
  }

  /**
   * Convert an instance of DeleteSuppressionRequest to an JSON string
   *
   * @return JSON string
   */
