...
public class AggregateStats {
  ...
  public AggregateStats processed(@javax.annotation.Nullable Integer processed) {
  ...
  public AggregateStats dropped(@javax.annotation.Nullable Integer dropped) {
  ...
  public AggregateStats hardBounced(@javax.annotation.Nullable Integer hardBounced) {
  ...
  public AggregateStats softBounced(@javax.annotation.Nullable Integer softBounced) {
  ...
  public AggregateStats opens(@javax.annotation.Nullable Integer opens) {
    this.opens = opens;
    return this;
  }
  ...
  public AggregateStats clicks(@javax.annotation.Nullable Integer clicks) {
    this.clicks = clicks;
    return this;
  }
  ...
  public AggregateStats unsubscribed(@javax.annotation.Nullable Integer unsubscribed) {
  ...
  public AggregateStats spams(@javax.annotation.Nullable Integer spams) {
    this.spams = spams;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.processed, aggregateStats.processed) &&
        ...
        Objects.equals(this.clicks, aggregateStats.clicks) &&
        Objects.equals(this.unsubscribed, aggregateStats.unsubscribed) &&
        Objects.equals(this.spams, aggregateStats.spams);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AggregateStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregateStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregateStats is not found in the empty JSON string", AggregateStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AggregateStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AggregateStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregateStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregateStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregateStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregateStats.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregateStats>() {
           @Override
           public void write(JsonWriter out, AggregateStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AggregateStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AggregateStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AggregateStats
   * @throws IOException if the JSON string is invalid with respect to AggregateStats
   */
  public static AggregateStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregateStats.class);
  }

  /**
   * Convert an instance of AggregateStats to an JSON string
   *
   * @return JSON string
   */
