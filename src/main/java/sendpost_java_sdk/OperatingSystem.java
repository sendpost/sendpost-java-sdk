...
public class OperatingSystem {
  ...
  public static final String SERIALIZED_NAME_PATCH_MINOR = "PatchMinor";
  ...
  public OperatingSystem family(@javax.annotation.Nullable String family) {
    this.family = family;
    return this;
  }
  ...
  public OperatingSystem major(@javax.annotation.Nullable String major) {
    this.major = major;
    return this;
  }
  ...
  public OperatingSystem minor(@javax.annotation.Nullable String minor) {
    this.minor = minor;
    return this;
  }
  ...
  public OperatingSystem patch(@javax.annotation.Nullable String patch) {
    this.patch = patch;
    return this;
  }
  ...
  public OperatingSystem patchMinor(@javax.annotation.Nullable String patchMinor) {
  ...
  public void setPatchMinor(@javax.annotation.Nullable String patchMinor) {
    this.patchMinor = patchMinor;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.family, operatingSystem.family) &&
        Objects.equals(this.major, operatingSystem.major) &&
        Objects.equals(this.minor, operatingSystem.minor) &&
        Objects.equals(this.patch, operatingSystem.patch) &&
        Objects.equals(this.patchMinor, operatingSystem.patchMinor);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("PatchMinor") != null && !jsonObj.get("PatchMinor").isJsonNull()) && !jsonObj.get("PatchMinor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `PatchMinor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("PatchMinor").toString()));
      }
  }
