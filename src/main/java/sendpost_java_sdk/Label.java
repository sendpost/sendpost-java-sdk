...
public class Label {
  ...
  public Label id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Label name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Label created(@javax.annotation.Nullable Long created) {
