...
public class NewSubAccount {
  ...
  public NewSubAccount name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NewSubAccount newSubAccount = (NewSubAccount) o;
    return Objects.equals(this.name, newSubAccount.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewSubAccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewSubAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewSubAccount is not found in the empty JSON string", NewSubAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewSubAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewSubAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewSubAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewSubAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewSubAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewSubAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<NewSubAccount>() {
           @Override
           public void write(JsonWriter out, NewSubAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewSubAccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewSubAccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewSubAccount
   * @throws IOException if the JSON string is invalid with respect to NewSubAccount
   */
  public static NewSubAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewSubAccount.class);
  }

  /**
   * Convert an instance of NewSubAccount to an JSON string
   *
   * @return JSON string
   */
