...
public class AccountStatsStat {
  ...
  public AccountStatsStat processed(@javax.annotation.Nullable Integer processed) {
  ...
  public AccountStatsStat sent(@javax.annotation.Nullable Integer sent) {
    this.sent = sent;
    return this;
  }
  ...
  public AccountStatsStat delivered(@javax.annotation.Nullable Integer delivered) {
  ...
  public AccountStatsStat dropped(@javax.annotation.Nullable Integer dropped) {
  ...
  public AccountStatsStat smtpDropped(@javax.annotation.Nullable Integer smtpDropped) {
  ...
  public AccountStatsStat hardBounced(@javax.annotation.Nullable Integer hardBounced) {
  ...
  public AccountStatsStat softBounced(@javax.annotation.Nullable Integer softBounced) {
  ...
  public AccountStatsStat opens(@javax.annotation.Nullable Integer opens) {
    this.opens = opens;
    return this;
  }
  ...
  public void setOpens(@javax.annotation.Nullable Integer opens) {
    this.opens = opens;
  }


  public AccountStatsStat clicks(@javax.annotation.Nullable Integer clicks) {
    this.clicks = clicks;
    return this;
  }
  ...
  public AccountStatsStat unsubscribed(@javax.annotation.Nullable Integer unsubscribed) {
  ...
  public boolean equals(Object o) {
    ...
    AccountStatsStat accountStatsStat = (AccountStatsStat) o;
    return Objects.equals(this.processed, accountStatsStat.processed) &&
        Objects.equals(this.sent, accountStatsStat.sent) &&
        Objects.equals(this.delivered, accountStatsStat.delivered) &&
        Objects.equals(this.dropped, accountStatsStat.dropped) &&
        Objects.equals(this.smtpDropped, accountStatsStat.smtpDropped) &&
        Objects.equals(this.hardBounced, accountStatsStat.hardBounced) &&
        Objects.equals(this.softBounced, accountStatsStat.softBounced) &&
        Objects.equals(this.opens, accountStatsStat.opens) &&
        Objects.equals(this.clicks, accountStatsStat.clicks) &&
  ...
  public String toString() {
    ...
    sb.append("class AccountStatsStat {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountStatsStat
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountStatsStat.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountStatsStat is not found in the empty JSON string", AccountStatsStat.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountStatsStat.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountStatsStat` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountStatsStat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountStatsStat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountStatsStat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountStatsStat.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountStatsStat>() {
           @Override
           public void write(JsonWriter out, AccountStatsStat value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountStatsStat read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountStatsStat given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountStatsStat
   * @throws IOException if the JSON string is invalid with respect to AccountStatsStat
   */
  public static AccountStatsStat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountStatsStat.class);
  }

  /**
   * Convert an instance of AccountStatsStat to an JSON string
   *
   * @return JSON string
   */
