...
public class MessageApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Successful retrieval of the message. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Message not found. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized. Invalid API key. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getMessageByIdCall(@javax.annotation.Nonnull String messageId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/account/message/{message_id}"
    ...
    private okhttp3.Call getMessageByIdValidateBeforeCall(@javax.annotation.Nonnull String messageId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Message getMessageById(@javax.annotation.Nonnull String messageId) throws ApiException {
        ApiResponse<Message> localVarResp = getMessageByIdWithHttpInfo(messageId);
     ...
     */
    public ApiResponse<Message> getMessageByIdWithHttpInfo(@javax.annotation.Nonnull String messageId) throws ApiException {
     ...
     */
    public okhttp3.Call getMessageByIdAsync(@javax.annotation.Nonnull String messageId, final ApiCallback<Message> _callback) throws ApiException {
