...
public class DomainDkim {
  ...
  public DomainDkim host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public DomainDkim type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public DomainDkim textValue(@javax.annotation.Nullable String textValue) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainDkim
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainDkim.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainDkim is not found in the empty JSON string", DomainDkim.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainDkim.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainDkim` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainDkim.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainDkim' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainDkim> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainDkim.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainDkim>() {
           @Override
           public void write(JsonWriter out, DomainDkim value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainDkim read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainDkim given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainDkim
   * @throws IOException if the JSON string is invalid with respect to DomainDkim
   */
  public static DomainDkim fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainDkim.class);
  }

  /**
   * Convert an instance of DomainDkim to an JSON string
   *
   * @return JSON string
   */
