...
import sendpost_java_sdk.IPPool;
import sendpost_java_sdk.IPPoolCreateRequest;
import sendpost_java_sdk.IPPoolDeleteResponse;
import sendpost_java_sdk.IPPoolUpdateRequest;
...
public class IpPoolsApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Created IPPool details </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden, IPPool with the same name already exists </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createIPPoolCall(@javax.annotation.Nonnull IPPoolCreateRequest ipPoolCreateRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = ipPoolCreateRequest;
    ...
    private okhttp3.Call createIPPoolValidateBeforeCall(@javax.annotation.Nonnull IPPoolCreateRequest ipPoolCreateRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ipPoolCreateRequest' is set
        if (ipPoolCreateRequest == null) {
            throw new ApiException("Missing the required parameter 'ipPoolCreateRequest' when calling createIPPool(Async)");
        }

        return createIPPoolCall(ipPoolCreateRequest, _callback);
     ...
     */
    public IPPool createIPPool(@javax.annotation.Nonnull IPPoolCreateRequest ipPoolCreateRequest) throws ApiException {
        ApiResponse<IPPool> localVarResp = createIPPoolWithHttpInfo(ipPoolCreateRequest);
     ...
     */
    public ApiResponse<IPPool> createIPPoolWithHttpInfo(@javax.annotation.Nonnull IPPoolCreateRequest ipPoolCreateRequest) throws ApiException {
        okhttp3.Call localVarCall = createIPPoolValidateBeforeCall(ipPoolCreateRequest, null);
     ...
     */
    public okhttp3.Call createIPPoolAsync(@javax.annotation.Nonnull IPPoolCreateRequest ipPoolCreateRequest, final ApiCallback<IPPool> _callback) throws ApiException {

        okhttp3.Call localVarCall = createIPPoolValidateBeforeCall(ipPoolCreateRequest, _callback);
        Type localVarReturnType = new TypeToken<IPPool>(){}.getType();
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successful deletion of the IPPool </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> IPPool not found </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteIPPoolCall(@javax.annotation.Nonnull Integer ippoolId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/account/ippool/{ippool_id}"
            .replace("{" + "ippool_id" + "}", localVarApiClient.escapeString(ippoolId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteIPPoolValidateBeforeCall(@javax.annotation.Nonnull Integer ippoolId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ippoolId' is set
        if (ippoolId == null) {
            throw new ApiException("Missing the required parameter 'ippoolId' when calling deleteIPPool(Async)");
        }

        return deleteIPPoolCall(ippoolId, _callback);
     ...
     */
    public IPPoolDeleteResponse deleteIPPool(@javax.annotation.Nonnull Integer ippoolId) throws ApiException {
        ApiResponse<IPPoolDeleteResponse> localVarResp = deleteIPPoolWithHttpInfo(ippoolId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IPPoolDeleteResponse> deleteIPPoolWithHttpInfo(@javax.annotation.Nonnull Integer ippoolId) throws ApiException {
        okhttp3.Call localVarCall = deleteIPPoolValidateBeforeCall(ippoolId, null);
        Type localVarReturnType = new TypeToken<IPPoolDeleteResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call deleteIPPoolAsync(@javax.annotation.Nonnull Integer ippoolId, final ApiCallback<IPPoolDeleteResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteIPPoolValidateBeforeCall(ippoolId, _callback);
        Type localVarReturnType = new TypeToken<IPPoolDeleteResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAllIPPools
     * @param limit Number of records to return per request (optional)
     * @param offset Number of initial records to skip (optional)
     * @param search Case insensitive search against IPPool name (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A list of IPPools </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAllIPPoolsCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllIPPoolsValidateBeforeCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        return getAllIPPoolsCall(limit, offset, search, _callback);
     ...
     */
    public List<IPPool> getAllIPPools(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search) throws ApiException {
        ApiResponse<List<IPPool>> localVarResp = getAllIPPoolsWithHttpInfo(limit, offset, search);
        return localVarResp.getData();
    }
     ...
     * @param offset Number of initial records to skip (optional)
     * @param search Case insensitive search against IPPool name (optional)
     * @return ApiResponse&lt;List&lt;IPPool&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<IPPool>> getAllIPPoolsWithHttpInfo(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search) throws ApiException {
        okhttp3.Call localVarCall = getAllIPPoolsValidateBeforeCall(limit, offset, search, null);
        Type localVarReturnType = new TypeToken<List<IPPool>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAllIPPoolsAsync(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String search, final ApiCallback<List<IPPool>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllIPPoolsValidateBeforeCall(limit, offset, search, _callback);
        Type localVarReturnType = new TypeToken<List<IPPool>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getIPPoolById
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Details of a specific IPPool </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getIPPoolByIdCall(@javax.annotation.Nonnull Integer ippoolId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getIPPoolByIdValidateBeforeCall(@javax.annotation.Nonnull Integer ippoolId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ippoolId' is set
        if (ippoolId == null) {
            throw new ApiException("Missing the required parameter 'ippoolId' when calling getIPPoolById(Async)");
        }

        return getIPPoolByIdCall(ippoolId, _callback);
     ...
     */
    public IPPool getIPPoolById(@javax.annotation.Nonnull Integer ippoolId) throws ApiException {
        ApiResponse<IPPool> localVarResp = getIPPoolByIdWithHttpInfo(ippoolId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IPPool> getIPPoolByIdWithHttpInfo(@javax.annotation.Nonnull Integer ippoolId) throws ApiException {
        okhttp3.Call localVarCall = getIPPoolByIdValidateBeforeCall(ippoolId, null);
        Type localVarReturnType = new TypeToken<IPPool>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getIPPoolByIdAsync(@javax.annotation.Nonnull Integer ippoolId, final ApiCallback<IPPool> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIPPoolByIdValidateBeforeCall(ippoolId, _callback);
        Type localVarReturnType = new TypeToken<IPPool>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The updated IPPool details </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad request - invalid or missing data </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> IPPool not found </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updateIPPoolCall(@javax.annotation.Nonnull Integer ippoolId, @javax.annotation.Nonnull IPPoolUpdateRequest ipPoolUpdateRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = ipPoolUpdateRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateIPPoolValidateBeforeCall(@javax.annotation.Nonnull Integer ippoolId, @javax.annotation.Nonnull IPPoolUpdateRequest ipPoolUpdateRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ippoolId' is set
        if (ippoolId == null) {
            throw new ApiException("Missing the required parameter 'ippoolId' when calling updateIPPool(Async)");
        }

        // verify the required parameter 'ipPoolUpdateRequest' is set
        if (ipPoolUpdateRequest == null) {
            throw new ApiException("Missing the required parameter 'ipPoolUpdateRequest' when calling updateIPPool(Async)");
        }

        return updateIPPoolCall(ippoolId, ipPoolUpdateRequest, _callback);
     ...
     */
    public IPPool updateIPPool(@javax.annotation.Nonnull Integer ippoolId, @javax.annotation.Nonnull IPPoolUpdateRequest ipPoolUpdateRequest) throws ApiException {
        ApiResponse<IPPool> localVarResp = updateIPPoolWithHttpInfo(ippoolId, ipPoolUpdateRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IPPool> updateIPPoolWithHttpInfo(@javax.annotation.Nonnull Integer ippoolId, @javax.annotation.Nonnull IPPoolUpdateRequest ipPoolUpdateRequest) throws ApiException {
        okhttp3.Call localVarCall = updateIPPoolValidateBeforeCall(ippoolId, ipPoolUpdateRequest, null);
        Type localVarReturnType = new TypeToken<IPPool>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateIPPoolAsync(@javax.annotation.Nonnull Integer ippoolId, @javax.annotation.Nonnull IPPoolUpdateRequest ipPoolUpdateRequest, final ApiCallback<IPPool> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateIPPoolValidateBeforeCall(ippoolId, ipPoolUpdateRequest, _callback);
        Type localVarReturnType = new TypeToken<IPPool>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
