...
public class UpdateWebhook {
  ...
  public UpdateWebhook enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public UpdateWebhook processed(@javax.annotation.Nullable Boolean processed) {
  ...
  public UpdateWebhook delivered(@javax.annotation.Nullable Boolean delivered) {
  ...
  public UpdateWebhook dropped(@javax.annotation.Nullable Boolean dropped) {
  ...
  public UpdateWebhook softBounced(@javax.annotation.Nullable Boolean softBounced) {
  ...
  public UpdateWebhook hardBounced(@javax.annotation.Nullable Boolean hardBounced) {
  ...
  public UpdateWebhook opened(@javax.annotation.Nullable Boolean opened) {
    this.opened = opened;
    return this;
  }
  ...
  public UpdateWebhook clicked(@javax.annotation.Nullable Boolean clicked) {
  ...
  public UpdateWebhook unsubscribed(@javax.annotation.Nullable Boolean unsubscribed) {
  ...
  public UpdateWebhook spam(@javax.annotation.Nullable Boolean spam) {
    this.spam = spam;
    return this;
  }
  ...
  public UpdateWebhook sent(@javax.annotation.Nullable Boolean sent) {
    this.sent = sent;
    return this;
  }
  ...
  public UpdateWebhook smtpDropped(@javax.annotation.Nullable Boolean smtpDropped) {
  ...
  public UpdateWebhook uniqueOpen(@javax.annotation.Nullable Boolean uniqueOpen) {
  ...
  public UpdateWebhook uniqueClick(@javax.annotation.Nullable Boolean uniqueClick) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, updateWebhook.enabled) &&
        Objects.equals(this.url, updateWebhook.url) &&
        Objects.equals(this.processed, updateWebhook.processed) &&
        Objects.equals(this.delivered, updateWebhook.delivered) &&
        Objects.equals(this.dropped, updateWebhook.dropped) &&
        Objects.equals(this.softBounced, updateWebhook.softBounced) &&
        Objects.equals(this.hardBounced, updateWebhook.hardBounced) &&
        Objects.equals(this.opened, updateWebhook.opened) &&
        Objects.equals(this.clicked, updateWebhook.clicked) &&
        Objects.equals(this.unsubscribed, updateWebhook.unsubscribed) &&
        Objects.equals(this.spam, updateWebhook.spam) &&
        Objects.equals(this.sent, updateWebhook.sent) &&
        Objects.equals(this.smtpDropped, updateWebhook.smtpDropped) &&
        Objects.equals(this.uniqueOpen, updateWebhook.uniqueOpen) &&
        Objects.equals(this.uniqueClick, updateWebhook.uniqueClick);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateWebhook
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateWebhook is not found in the empty JSON string", UpdateWebhook.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWebhook.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateWebhook` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWebhook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWebhook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWebhook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWebhook.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWebhook>() {
           @Override
           public void write(JsonWriter out, UpdateWebhook value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWebhook read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateWebhook given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateWebhook
   * @throws IOException if the JSON string is invalid with respect to UpdateWebhook
   */
  public static UpdateWebhook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWebhook.class);
  }

  /**
   * Convert an instance of UpdateWebhook to an JSON string
   *
   * @return JSON string
   */
