...
public class IPPoolDeleteResponse {
  ...
  public IPPoolDeleteResponse() {
  }

  public IPPoolDeleteResponse id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public IPPoolDeleteResponse message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    IPPoolDeleteResponse ipPoolDeleteResponse = (IPPoolDeleteResponse) o;
    return Objects.equals(this.id, ipPoolDeleteResponse.id) &&
        Objects.equals(this.message, ipPoolDeleteResponse.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPPoolDeleteResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPPoolDeleteResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPPoolDeleteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPPoolDeleteResponse is not found in the empty JSON string", IPPoolDeleteResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPPoolDeleteResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPPoolDeleteResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPPoolDeleteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPPoolDeleteResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPPoolDeleteResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPPoolDeleteResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IPPoolDeleteResponse>() {
           @Override
           public void write(JsonWriter out, IPPoolDeleteResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPPoolDeleteResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPPoolDeleteResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPPoolDeleteResponse
   * @throws IOException if the JSON string is invalid with respect to IPPoolDeleteResponse
   */
  public static IPPoolDeleteResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPPoolDeleteResponse.class);
  }

  /**
   * Convert an instance of IPPoolDeleteResponse to an JSON string
   *
   * @return JSON string
   */
