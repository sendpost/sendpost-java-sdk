...
public class IPPoolCreateRequest {
  ...
  @javax.annotation.Nullable
  private List<EIP> ips = new ArrayList<>();

  public static final String SERIALIZED_NAME_TPSPS = "tpsps";
  @SerializedName(SERIALIZED_NAME_TPSPS)
  @javax.annotation.Nullable
  private List<Integer> tpsps = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_OVERFLOW_POOL = "overflowPool";
  ...
  public IPPoolCreateRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IPPoolCreateRequest ips(@javax.annotation.Nullable List<EIP> ips) {
    this.ips = ips;
    return this;
  }

  public IPPoolCreateRequest addIpsItem(EIP ipsItem) {
    if (this.ips == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<EIP> getIps() {
    return ips;
  }

  public void setIps(@javax.annotation.Nullable List<EIP> ips) {
    this.ips = ips;
  }


  public IPPoolCreateRequest tpsps(@javax.annotation.Nullable List<Integer> tpsps) {
    this.tpsps = tpsps;
    return this;
  }

  public IPPoolCreateRequest addTpspsItem(Integer tpspsItem) {
    if (this.tpsps == null) {
      this.tpsps = new ArrayList<>();
    }
    this.tpsps.add(tpspsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Integer> getTpsps() {
    return tpsps;
  }

  public void setTpsps(@javax.annotation.Nullable List<Integer> tpsps) {
    this.tpsps = tpsps;
  }


  public IPPoolCreateRequest routingStrategy(@javax.annotation.Nullable Integer routingStrategy) {
  ...
  public IPPoolCreateRequest routingMetaData(@javax.annotation.Nullable String routingMetaData) {
  ...
  public IPPoolCreateRequest overflowPool(@javax.annotation.Nullable Boolean overflowPool) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getOverflowPool() {
    return overflowPool;
  }

  public void setOverflowPool(@javax.annotation.Nullable Boolean overflowPool) {
    this.overflowPool = overflowPool;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPPoolCreateRequest ipPoolCreateRequest = (IPPoolCreateRequest) o;
    return Objects.equals(this.name, ipPoolCreateRequest.name) &&
        Objects.equals(this.ips, ipPoolCreateRequest.ips) &&
  ...
  public String toString() {
    ...
    sb.append("class IPPoolCreateRequest {\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    ips: ").append(toIndentedString(ips)).append("\n");
    sb.append("    tpsps: ").append(toIndentedString(tpsps)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPPoolCreateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPPoolCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPPoolCreateRequest is not found in the empty JSON string", IPPoolCreateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPPoolCreateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPPoolCreateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ips") != null && !jsonObj.get("ips").isJsonNull()) {
        ...
        if (jsonArrayips != null) {
          ...
          for (int i = 0; i < jsonArrayips.size(); i++) {
            EIP.validateJsonElement(jsonArrayips.get(i));
          };
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("tpsps") != null && !jsonObj.get("tpsps").isJsonNull() && !jsonObj.get("tpsps").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `tpsps` to be an array in the JSON string but got `%s`", jsonObj.get("tpsps").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPPoolCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPPoolCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPPoolCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPPoolCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<IPPoolCreateRequest>() {
           @Override
           public void write(JsonWriter out, IPPoolCreateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPPoolCreateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPPoolCreateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPPoolCreateRequest
   * @throws IOException if the JSON string is invalid with respect to IPPoolCreateRequest
   */
  public static IPPoolCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPPoolCreateRequest.class);
  }

  /**
   * Convert an instance of IPPoolCreateRequest to an JSON string
   *
   * @return JSON string
   */
