...
public class UserAgent {
  ...
  public UserAgent family(@javax.annotation.Nullable String family) {
    this.family = family;
    return this;
  }
  ...
  public UserAgent major(@javax.annotation.Nullable String major) {
    this.major = major;
    return this;
  }
  ...
  public UserAgent minor(@javax.annotation.Nullable String minor) {
    this.minor = minor;
    return this;
  }
  ...
  public UserAgent patch(@javax.annotation.Nullable String patch) {
    this.patch = patch;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.family, userAgent.family) &&
        Objects.equals(this.major, userAgent.major) &&
        Objects.equals(this.minor, userAgent.minor) &&
        Objects.equals(this.patch, userAgent.patch);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserAgent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAgent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAgent is not found in the empty JSON string", UserAgent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAgent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAgent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAgent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAgent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAgent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAgent.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAgent>() {
           @Override
           public void write(JsonWriter out, UserAgent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAgent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserAgent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserAgent
   * @throws IOException if the JSON string is invalid with respect to UserAgent
   */
  public static UserAgent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAgent.class);
  }

  /**
   * Convert an instance of UserAgent to an JSON string
   *
   * @return JSON string
   */
