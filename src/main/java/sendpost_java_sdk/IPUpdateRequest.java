...
public class IPUpdateRequest {
  ...
  public IPUpdateRequest() {
  }

  public IPUpdateRequest autoWarmupEnabled(@javax.annotation.Nonnull Boolean autoWarmupEnabled) {
  ...
  public void setAutoWarmupEnabled(@javax.annotation.Nonnull Boolean autoWarmupEnabled) {
    this.autoWarmupEnabled = autoWarmupEnabled;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPUpdateRequest ipUpdateRequest = (IPUpdateRequest) o;
    return Objects.equals(this.autoWarmupEnabled, ipUpdateRequest.autoWarmupEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoWarmupEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IPUpdateRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("autoWarmupEnabled");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPUpdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPUpdateRequest is not found in the empty JSON string", IPUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IPUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<IPUpdateRequest>() {
           @Override
           public void write(JsonWriter out, IPUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPUpdateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPUpdateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPUpdateRequest
   * @throws IOException if the JSON string is invalid with respect to IPUpdateRequest
   */
  public static IPUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPUpdateRequest.class);
  }

  /**
   * Convert an instance of IPUpdateRequest to an JSON string
   *
   * @return JSON string
   */
