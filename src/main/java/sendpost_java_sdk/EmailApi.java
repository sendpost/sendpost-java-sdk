...
import sendpost_java_sdk.EmailMessageObject;
import sendpost_java_sdk.EmailMessageWithTemplate;
import sendpost_java_sdk.EmailResponse;
...
public class EmailApi {
     ...
     * @param emailMessageObject Email message details (required)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> A list of email message response objects. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call sendEmailCall(@javax.annotation.Nonnull EmailMessageObject emailMessageObject, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = emailMessageObject;
    ...
    private okhttp3.Call sendEmailValidateBeforeCall(@javax.annotation.Nonnull EmailMessageObject emailMessageObject, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'emailMessageObject' is set
        if (emailMessageObject == null) {
            throw new ApiException("Missing the required parameter 'emailMessageObject' when calling sendEmail(Async)");
        }

        return sendEmailCall(emailMessageObject, _callback);
     ...
     */
    public List<EmailResponse> sendEmail(@javax.annotation.Nonnull EmailMessageObject emailMessageObject) throws ApiException {
        ApiResponse<List<EmailResponse>> localVarResp = sendEmailWithHttpInfo(emailMessageObject);
     ...
     * Use this API to send either a single or batch email.
     * @param emailMessageObject Email message details (required)
     * @return ApiResponse&lt;List&lt;EmailResponse&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<EmailResponse>> sendEmailWithHttpInfo(@javax.annotation.Nonnull EmailMessageObject emailMessageObject) throws ApiException {
        okhttp3.Call localVarCall = sendEmailValidateBeforeCall(emailMessageObject, null);
        Type localVarReturnType = new TypeToken<List<EmailResponse>>(){}.getType();
     ...
     */
    public okhttp3.Call sendEmailAsync(@javax.annotation.Nonnull EmailMessageObject emailMessageObject, final ApiCallback<List<EmailResponse>> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendEmailValidateBeforeCall(emailMessageObject, _callback);
        Type localVarReturnType = new TypeToken<List<EmailResponse>>(){}.getType();
     ...
     * @param emailMessageWithTemplate Email message details with template information (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call sendEmailWithTemplateCall(@javax.annotation.Nonnull EmailMessageWithTemplate emailMessageWithTemplate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = emailMessageWithTemplate;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sendEmailWithTemplateValidateBeforeCall(@javax.annotation.Nonnull EmailMessageWithTemplate emailMessageWithTemplate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'emailMessageWithTemplate' is set
        if (emailMessageWithTemplate == null) {
            throw new ApiException("Missing the required parameter 'emailMessageWithTemplate' when calling sendEmailWithTemplate(Async)");
        }

        return sendEmailWithTemplateCall(emailMessageWithTemplate, _callback);
     ...
     */
    public List<EmailResponse> sendEmailWithTemplate(@javax.annotation.Nonnull EmailMessageWithTemplate emailMessageWithTemplate) throws ApiException {
        ApiResponse<List<EmailResponse>> localVarResp = sendEmailWithTemplateWithHttpInfo(emailMessageWithTemplate);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<EmailResponse>> sendEmailWithTemplateWithHttpInfo(@javax.annotation.Nonnull EmailMessageWithTemplate emailMessageWithTemplate) throws ApiException {
        okhttp3.Call localVarCall = sendEmailWithTemplateValidateBeforeCall(emailMessageWithTemplate, null);
        Type localVarReturnType = new TypeToken<List<EmailResponse>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call sendEmailWithTemplateAsync(@javax.annotation.Nonnull EmailMessageWithTemplate emailMessageWithTemplate, final ApiCallback<List<EmailResponse>> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendEmailWithTemplateValidateBeforeCall(emailMessageWithTemplate, _callback);
        Type localVarReturnType = new TypeToken<List<EmailResponse>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
