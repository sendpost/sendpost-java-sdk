...
public class DomainDmarc {
  ...
  public DomainDmarc host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public DomainDmarc type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public DomainDmarc textValue(@javax.annotation.Nullable String textValue) {
  ...
  public boolean equals(Object o) {
    ...
    DomainDmarc domainDmarc = (DomainDmarc) o;
    return Objects.equals(this.host, domainDmarc.host) &&
        Objects.equals(this.type, domainDmarc.type) &&
        Objects.equals(this.textValue, domainDmarc.textValue);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainDmarc
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainDmarc.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainDmarc is not found in the empty JSON string", DomainDmarc.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainDmarc.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainDmarc` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainDmarc.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainDmarc' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainDmarc> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainDmarc.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainDmarc>() {
           @Override
           public void write(JsonWriter out, DomainDmarc value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainDmarc read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainDmarc given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainDmarc
   * @throws IOException if the JSON string is invalid with respect to DomainDmarc
   */
  public static DomainDmarc fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainDmarc.class);
  }

  /**
   * Convert an instance of DomainDmarc to an JSON string
   *
   * @return JSON string
   */
