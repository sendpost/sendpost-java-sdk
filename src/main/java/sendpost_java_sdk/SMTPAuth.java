...
public class SMTPAuth {
  ...
  public SMTPAuth id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SMTPAuth username(@javax.annotation.Nullable String username) {
  ...
  public SMTPAuth password(@javax.annotation.Nullable String password) {
  ...
  public boolean equals(Object o) {
    ...
    SMTPAuth smTPAuth = (SMTPAuth) o;
    return Objects.equals(this.id, smTPAuth.id) &&
        Objects.equals(this.username, smTPAuth.username) &&
        Objects.equals(this.password, smTPAuth.password) &&
        Objects.equals(this.created, smTPAuth.created) &&
        Objects.equals(this.updated, smTPAuth.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, username, password, created, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SMTPAuth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SMTPAuth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SMTPAuth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SMTPAuth is not found in the empty JSON string", SMTPAuth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SMTPAuth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SMTPAuth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SMTPAuth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SMTPAuth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SMTPAuth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SMTPAuth.class));

       return (TypeAdapter<T>) new TypeAdapter<SMTPAuth>() {
           @Override
           public void write(JsonWriter out, SMTPAuth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SMTPAuth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SMTPAuth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SMTPAuth
   * @throws IOException if the JSON string is invalid with respect to SMTPAuth
   */
  public static SMTPAuth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SMTPAuth.class);
  }

  /**
   * Convert an instance of SMTPAuth to an JSON string
   *
   * @return JSON string
   */
