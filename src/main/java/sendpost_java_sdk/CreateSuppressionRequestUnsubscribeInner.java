...
public class CreateSuppressionRequestUnsubscribeInner {
  public static final String SERIALIZED_NAME_EMAIL = "email";
  @SerializedName(SERIALIZED_NAME_EMAIL)
  @javax.annotation.Nullable
  private String email;

  public CreateSuppressionRequestUnsubscribeInner() {
  }

  public CreateSuppressionRequestUnsubscribeInner email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateSuppressionRequestUnsubscribeInner createSuppressionRequestUnsubscribeInner = (CreateSuppressionRequestUnsubscribeInner) o;
    return Objects.equals(this.email, createSuppressionRequestUnsubscribeInner.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSuppressionRequestUnsubscribeInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSuppressionRequestUnsubscribeInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSuppressionRequestUnsubscribeInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSuppressionRequestUnsubscribeInner is not found in the empty JSON string", CreateSuppressionRequestUnsubscribeInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSuppressionRequestUnsubscribeInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSuppressionRequestUnsubscribeInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSuppressionRequestUnsubscribeInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSuppressionRequestUnsubscribeInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSuppressionRequestUnsubscribeInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSuppressionRequestUnsubscribeInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSuppressionRequestUnsubscribeInner>() {
           @Override
           public void write(JsonWriter out, CreateSuppressionRequestUnsubscribeInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSuppressionRequestUnsubscribeInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSuppressionRequestUnsubscribeInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSuppressionRequestUnsubscribeInner
   * @throws IOException if the JSON string is invalid with respect to CreateSuppressionRequestUnsubscribeInner
   */
  public static CreateSuppressionRequestUnsubscribeInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSuppressionRequestUnsubscribeInner.class);
  }

  /**
   * Convert an instance of CreateSuppressionRequestUnsubscribeInner to an JSON string
   *
   * @return JSON string
   */
