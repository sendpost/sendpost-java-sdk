...
public class EmailMessageToInnerBccInner {
  ...
  public EmailMessageToInnerBccInner() {
  }

  public EmailMessageToInnerBccInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EmailMessageToInnerBccInner email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public EmailMessageToInnerBccInner customFields(@javax.annotation.Nullable Map<String, String> customFields) {
    this.customFields = customFields;
    return this;
  }

  public EmailMessageToInnerBccInner putCustomFieldsItem(String key, String customFieldsItem) {
  ...
  public boolean equals(Object o) {
    ...
    EmailMessageToInnerBccInner emailMessageToInnerBccInner = (EmailMessageToInnerBccInner) o;
    return Objects.equals(this.name, emailMessageToInnerBccInner.name) &&
        Objects.equals(this.email, emailMessageToInnerBccInner.email) &&
        Objects.equals(this.customFields, emailMessageToInnerBccInner.customFields);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, email, customFields);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailMessageToInnerBccInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailMessageToInnerBccInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailMessageToInnerBccInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailMessageToInnerBccInner is not found in the empty JSON string", EmailMessageToInnerBccInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailMessageToInnerBccInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailMessageToInnerBccInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailMessageToInnerBccInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailMessageToInnerBccInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailMessageToInnerBccInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailMessageToInnerBccInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailMessageToInnerBccInner>() {
           @Override
           public void write(JsonWriter out, EmailMessageToInnerBccInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailMessageToInnerBccInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailMessageToInnerBccInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailMessageToInnerBccInner
   * @throws IOException if the JSON string is invalid with respect to EmailMessageToInnerBccInner
   */
  public static EmailMessageToInnerBccInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailMessageToInnerBccInner.class);
  }

  /**
   * Convert an instance of EmailMessageToInnerBccInner to an JSON string
   *
   * @return JSON string
   */
