...
import sendpost_java_sdk.AccountStats;
import sendpost_java_sdk.AggregateStat;
import sendpost_java_sdk.AggregateStats;
import java.time.LocalDate;
import sendpost_java_sdk.Stat;
...
public class StatsAApi {
    ...
    public StatsAApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAccountAggregateStats
     * @param from The start date for retrieving aggregated stats (inclusive) (required)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Aggregated statistics for the specified date range. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad request, invalid date range </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized, invalid API key </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Data not found for the given date range </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAccountAggregateStatsCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAccountAggregateStatsValidateBeforeCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getAccountAggregateStats(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getAccountAggregateStats(Async)");
        }

        return getAccountAggregateStatsCall(from, to, _callback);
     ...
     */
    public AggregateStats getAccountAggregateStats(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to) throws ApiException {
        ApiResponse<AggregateStats> localVarResp = getAccountAggregateStatsWithHttpInfo(from, to);
     ...
     * @param from The start date for retrieving aggregated stats (inclusive) (required)
     * @param to The end date for retrieving aggregated stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 366 days. (required)
     * @return ApiResponse&lt;AggregateStats&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<AggregateStats> getAccountAggregateStatsWithHttpInfo(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to) throws ApiException {
        okhttp3.Call localVarCall = getAccountAggregateStatsValidateBeforeCall(from, to, null);
        Type localVarReturnType = new TypeToken<AggregateStats>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Account Aggregate Stats (asynchronously)
     * Retrieve aggregated email statistics for all sub-accounts of a specific account for a given date range.
     * @param from The start date for retrieving aggregated stats (inclusive) (required)
     * @param to The end date for retrieving aggregated stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 366 days. (required)
     ...
     */
    public okhttp3.Call getAccountAggregateStatsAsync(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback<AggregateStats> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountAggregateStatsValidateBeforeCall(from, to, _callback);
        Type localVarReturnType = new TypeToken<AggregateStats>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAccountAggregateStatsByGroup
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successfully retrieved aggregate stats by group. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request, invalid query parameters. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized, invalid API key. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAccountAggregateStatsByGroupCall(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAccountAggregateStatsByGroupValidateBeforeCall(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'group' is set
        if (group == null) {
            throw new ApiException("Missing the required parameter 'group' when calling getAccountAggregateStatsByGroup(Async)");
        }

        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getAccountAggregateStatsByGroup(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getAccountAggregateStatsByGroup(Async)");
        }

        return getAccountAggregateStatsByGroupCall(group, from, to, _callback);
     ...
     */
    public AggregateStat getAccountAggregateStatsByGroup(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to) throws ApiException {
        ApiResponse<AggregateStat> localVarResp = getAccountAggregateStatsByGroupWithHttpInfo(group, from, to);
        return localVarResp.getData();
    }
     ...
     * @param from Date from which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;). (required)
     * @param to Date to which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;). Note that the difference between &#x60;from&#x60; and &#x60;to&#x60; should not be more than 366 days. (required)
     * @return ApiResponse&lt;AggregateStat&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<AggregateStat> getAccountAggregateStatsByGroupWithHttpInfo(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to) throws ApiException {
        okhttp3.Call localVarCall = getAccountAggregateStatsByGroupValidateBeforeCall(group, from, to, null);
        Type localVarReturnType = new TypeToken<AggregateStat>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAccountAggregateStatsByGroupAsync(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback<AggregateStat> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountAggregateStatsByGroupValidateBeforeCall(group, from, to, _callback);
        Type localVarReturnType = new TypeToken<AggregateStat>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAccountStatsByGroup
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successfully retrieved stats by group. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request, invalid query parameters. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized, invalid API key. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAccountStatsByGroupCall(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAccountStatsByGroupValidateBeforeCall(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'group' is set
        if (group == null) {
            throw new ApiException("Missing the required parameter 'group' when calling getAccountStatsByGroup(Async)");
        }

        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getAccountStatsByGroup(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getAccountStatsByGroup(Async)");
        }

        return getAccountStatsByGroupCall(group, from, to, _callback);
     ...
     */
    public List<Stat> getAccountStatsByGroup(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to) throws ApiException {
        ApiResponse<List<Stat>> localVarResp = getAccountStatsByGroupWithHttpInfo(group, from, to);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Stat>> getAccountStatsByGroupWithHttpInfo(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to) throws ApiException {
        okhttp3.Call localVarCall = getAccountStatsByGroupValidateBeforeCall(group, from, to, null);
     ...
     */
    public okhttp3.Call getAccountStatsByGroupAsync(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback<List<Stat>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountStatsByGroupValidateBeforeCall(group, from, to, _callback);
        Type localVarReturnType = new TypeToken<List<Stat>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAllAccountStats
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A list of statistics for the specified date range. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad request, invalid date range </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized, invalid API key </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Data not found for the given date range </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAllAccountStatsCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllAccountStatsValidateBeforeCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getAllAccountStats(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getAllAccountStats(Async)");
        }

        return getAllAccountStatsCall(from, to, _callback);
     ...
     */
    public List<AccountStats> getAllAccountStats(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to) throws ApiException {
        ApiResponse<List<AccountStats>> localVarResp = getAllAccountStatsWithHttpInfo(from, to);
        return localVarResp.getData();
    }
     ...
     * @param from The start date for retrieving stats (inclusive) (required)
     * @param to The end date for retrieving stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 31 days. (required)
     * @return ApiResponse&lt;List&lt;AccountStats&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<AccountStats>> getAllAccountStatsWithHttpInfo(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to) throws ApiException {
        okhttp3.Call localVarCall = getAllAccountStatsValidateBeforeCall(from, to, null);
        Type localVarReturnType = new TypeToken<List<AccountStats>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAllAccountStatsAsync(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, final ApiCallback<List<AccountStats>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllAccountStatsValidateBeforeCall(from, to, _callback);
        Type localVarReturnType = new TypeToken<List<AccountStats>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
