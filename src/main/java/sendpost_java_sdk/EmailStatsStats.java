...
public class EmailStatsStats {
  ...
  public EmailStatsStats() {
  }

  public EmailStatsStats processed(@javax.annotation.Nullable Integer processed) {
  ...
  public EmailStatsStats dropped(@javax.annotation.Nullable Integer dropped) {
  ...
  public EmailStatsStats hardBounced(@javax.annotation.Nullable Integer hardBounced) {
  ...
  public EmailStatsStats softBounced(@javax.annotation.Nullable Integer softBounced) {
  ...
  public EmailStatsStats opened(@javax.annotation.Nullable Integer opened) {
    this.opened = opened;
    return this;
  }
  ...
  public EmailStatsStats clicked(@javax.annotation.Nullable Integer clicked) {
  ...
  public EmailStatsStats unsubscribed(@javax.annotation.Nullable Integer unsubscribed) {
  ...
  public EmailStatsStats spam(@javax.annotation.Nullable Integer spam) {
    this.spam = spam;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.processed, emailStatsStats.processed) &&
        ...
        Objects.equals(this.clicked, emailStatsStats.clicked) &&
        Objects.equals(this.unsubscribed, emailStatsStats.unsubscribed) &&
        Objects.equals(this.spam, emailStatsStats.spam);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailStatsStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailStatsStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailStatsStats is not found in the empty JSON string", EmailStatsStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailStatsStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailStatsStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailStatsStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailStatsStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailStatsStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailStatsStats.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailStatsStats>() {
           @Override
           public void write(JsonWriter out, EmailStatsStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailStatsStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailStatsStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailStatsStats
   * @throws IOException if the JSON string is invalid with respect to EmailStatsStats
   */
  public static EmailStatsStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailStatsStats.class);
  }

  /**
   * Convert an instance of EmailStatsStats to an JSON string
   *
   * @return JSON string
   */
