...
public class DeleteWebhookResponse {
  ...
  public DeleteWebhookResponse id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DeleteWebhookResponse message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, deleteWebhookResponse.id) &&
        Objects.equals(this.message, deleteWebhookResponse.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteWebhookResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteWebhookResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteWebhookResponse is not found in the empty JSON string", DeleteWebhookResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteWebhookResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteWebhookResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteWebhookResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteWebhookResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteWebhookResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteWebhookResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteWebhookResponse>() {
           @Override
           public void write(JsonWriter out, DeleteWebhookResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteWebhookResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteWebhookResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteWebhookResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteWebhookResponse
   */
  public static DeleteWebhookResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteWebhookResponse.class);
  }

  /**
   * Convert an instance of DeleteWebhookResponse to an JSON string
   *
   * @return JSON string
   */
