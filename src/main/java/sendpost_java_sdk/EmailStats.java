...
import sendpost_java_sdk.EmailStatsStats;
...
public class EmailStats {
  ...
  @javax.annotation.Nullable
  private EmailStatsStats stats;

  public EmailStats() {
  }

  public EmailStats date(@javax.annotation.Nullable LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  public EmailStats stats(@javax.annotation.Nullable EmailStatsStats stats) {
    this.stats = stats;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public EmailStatsStats getStats() {
    return stats;
  }

  public void setStats(@javax.annotation.Nullable EmailStatsStats stats) {
    this.stats = stats;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailStats emailStats = (EmailStats) o;
    return Objects.equals(this.date, emailStats.date) &&
        Objects.equals(this.stats, emailStats.stats);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailStats is not found in the empty JSON string", EmailStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `stats`
      if (jsonObj.get("stats") != null && !jsonObj.get("stats").isJsonNull()) {
        EmailStatsStats.validateJsonElement(jsonObj.get("stats"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailStats.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailStats>() {
           @Override
           public void write(JsonWriter out, EmailStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailStats
   * @throws IOException if the JSON string is invalid with respect to EmailStats
   */
  public static EmailStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailStats.class);
  }

  /**
   * Convert an instance of EmailStats to an JSON string
   *
   * @return JSON string
   */
