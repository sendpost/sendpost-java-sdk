...
public class DomainTrack {
  ...
  public DomainTrack host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public DomainTrack type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public DomainTrack textValue(@javax.annotation.Nullable String textValue) {
  ...
  public boolean equals(Object o) {
    ...
    DomainTrack domainTrack = (DomainTrack) o;
    return Objects.equals(this.host, domainTrack.host) &&
        Objects.equals(this.type, domainTrack.type) &&
        Objects.equals(this.textValue, domainTrack.textValue);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainTrack
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainTrack.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainTrack is not found in the empty JSON string", DomainTrack.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainTrack.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainTrack` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainTrack.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainTrack' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainTrack> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainTrack.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainTrack>() {
           @Override
           public void write(JsonWriter out, DomainTrack value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainTrack read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainTrack given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainTrack
   * @throws IOException if the JSON string is invalid with respect to DomainTrack
   */
  public static DomainTrack fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainTrack.class);
  }

  /**
   * Convert an instance of DomainTrack to an JSON string
   *
   * @return JSON string
   */
