...
import sendpost_java_sdk.WebhookObject;
...
public class WebhookReferenceApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public WebhookReferenceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public WebhookReferenceApi(ApiClient apiClient) {
    ...
    /**
     * Build call for sendPostWebhooksPost
     * @param webhookObject  (optional)
     ...
     */
    public okhttp3.Call sendPostWebhooksPostCall(@javax.annotation.Nullable WebhookObject webhookObject, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = webhookObject;

        // create path and map variables
        String localVarPath = "/SendPostWebhooks";
    ...
    private okhttp3.Call sendPostWebhooksPostValidateBeforeCall(@javax.annotation.Nullable WebhookObject webhookObject, final ApiCallback _callback) throws ApiException {
        return sendPostWebhooksPostCall(webhookObject, _callback);
     ...
     */
    public void sendPostWebhooksPost(@javax.annotation.Nullable WebhookObject webhookObject) throws ApiException {
        sendPostWebhooksPostWithHttpInfo(webhookObject);
    }
     ...
     */
    public ApiResponse<Void> sendPostWebhooksPostWithHttpInfo(@javax.annotation.Nullable WebhookObject webhookObject) throws ApiException {
        okhttp3.Call localVarCall = sendPostWebhooksPostValidateBeforeCall(webhookObject, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * SendPost Webhook Object (asynchronously)
     * 
     * @param webhookObject  (optional)
     ...
     */
    public okhttp3.Call sendPostWebhooksPostAsync(@javax.annotation.Nullable WebhookObject webhookObject, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendPostWebhooksPostValidateBeforeCall(webhookObject, _callback);
