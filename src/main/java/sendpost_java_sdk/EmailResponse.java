...
public class EmailResponse {
  ...
  public EmailResponse to(@javax.annotation.Nullable String to) {
    this.to = to;
    return this;
  }
  ...
  public EmailResponse messageId(@javax.annotation.Nullable String messageId) {
  ...
  public EmailResponse errorCode(@javax.annotation.Nullable Integer errorCode) {
  ...
  public EmailResponse message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.to, emailResponse.to) &&
