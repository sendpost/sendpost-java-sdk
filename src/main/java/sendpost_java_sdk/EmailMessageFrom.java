...
public class EmailMessageFrom {
  ...
  public EmailMessageFrom() {
  }

  public EmailMessageFrom name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EmailMessageFrom email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailMessageFrom emailMessageFrom = (EmailMessageFrom) o;
    return Objects.equals(this.name, emailMessageFrom.name) &&
        Objects.equals(this.email, emailMessageFrom.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailMessageFrom {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailMessageFrom
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailMessageFrom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailMessageFrom is not found in the empty JSON string", EmailMessageFrom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailMessageFrom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailMessageFrom` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailMessageFrom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailMessageFrom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailMessageFrom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailMessageFrom.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailMessageFrom>() {
           @Override
           public void write(JsonWriter out, EmailMessageFrom value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailMessageFrom read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailMessageFrom given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailMessageFrom
   * @throws IOException if the JSON string is invalid with respect to EmailMessageFrom
   */
  public static EmailMessageFrom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailMessageFrom.class);
  }

  /**
   * Convert an instance of EmailMessageFrom to an JSON string
   *
   * @return JSON string
   */
