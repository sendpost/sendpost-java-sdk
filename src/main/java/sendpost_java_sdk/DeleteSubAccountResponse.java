...
public class DeleteSubAccountResponse {
  ...
  public DeleteSubAccountResponse() {
  }

  public DeleteSubAccountResponse id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DeleteSubAccountResponse message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSubAccountResponse deleteSubAccountResponse = (DeleteSubAccountResponse) o;
    return Objects.equals(this.id, deleteSubAccountResponse.id) &&
        Objects.equals(this.message, deleteSubAccountResponse.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSubAccountResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSubAccountResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSubAccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSubAccountResponse is not found in the empty JSON string", DeleteSubAccountResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSubAccountResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSubAccountResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSubAccountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSubAccountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSubAccountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSubAccountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSubAccountResponse>() {
           @Override
           public void write(JsonWriter out, DeleteSubAccountResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSubAccountResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSubAccountResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSubAccountResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteSubAccountResponse
   */
  public static DeleteSubAccountResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSubAccountResponse.class);
  }

  /**
   * Convert an instance of DeleteSubAccountResponse to an JSON string
   *
   * @return JSON string
   */
