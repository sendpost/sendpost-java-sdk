...
public class StatsApi {
    ...
    /**
     * Build call for accountSubaccountStatSubaccountIdAggregateGet
     ...
     * @param subaccountId The ID of the subaccount to retrieve (required)
     ...
     */
    public okhttp3.Call accountSubaccountStatSubaccountIdAggregateGetCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/account/subaccount/stat/{subaccount_id}/aggregate"
    ...
    private okhttp3.Call accountSubaccountStatSubaccountIdAggregateGetValidateBeforeCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling accountSubaccountStatSubaccountIdAggregateGet(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling accountSubaccountStatSubaccountIdAggregateGet(Async)");
        }

        // verify the required parameter 'subaccountId' is set
        if (subaccountId == null) {
            throw new ApiException("Missing the required parameter 'subaccountId' when calling accountSubaccountStatSubaccountIdAggregateGet(Async)");
        }

        return accountSubaccountStatSubaccountIdAggregateGetCall(from, to, subaccountId, _callback);
     ...
     */
    public AggregateStat accountSubaccountStatSubaccountIdAggregateGet(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId) throws ApiException {
        ApiResponse<AggregateStat> localVarResp = accountSubaccountStatSubaccountIdAggregateGetWithHttpInfo(from, to, subaccountId);
     ...
     */
    public ApiResponse<AggregateStat> accountSubaccountStatSubaccountIdAggregateGetWithHttpInfo(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId) throws ApiException {
        okhttp3.Call localVarCall = accountSubaccountStatSubaccountIdAggregateGetValidateBeforeCall(from, to, subaccountId, null);
        Type localVarReturnType = new TypeToken<AggregateStat>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Aggregate Stats (asynchronously)
     * Retrieves aggregated email stats for a specific sub-account for a date range.   **Note**: The maximum date range is 366 days. 
     * @param from Start date for stats retrieval. (required)
     * @param to Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn&#39;t ne more than 60 days )  (required)
     * @param subaccountId The ID of the subaccount to retrieve (required)
     ...
     */
    public okhttp3.Call accountSubaccountStatSubaccountIdAggregateGetAsync(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback<AggregateStat> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountSubaccountStatSubaccountIdAggregateGetValidateBeforeCall(from, to, subaccountId, _callback);
        Type localVarReturnType = new TypeToken<AggregateStat>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for accountSubaccountStatSubaccountIdGet
     * @param from Start date for stats retrieval. (required)
     * @param to Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn&#39;t ne more than 60 days )  (required)
     * @param subaccountId The ID of the subaccount to retrieve (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call accountSubaccountStatSubaccountIdGetCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/account/subaccount/stat/{subaccount_id}"
            .replace("{" + "subaccount_id" + "}", localVarApiClient.escapeString(subaccountId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountSubaccountStatSubaccountIdGetValidateBeforeCall(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling accountSubaccountStatSubaccountIdGet(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling accountSubaccountStatSubaccountIdGet(Async)");
        }

        // verify the required parameter 'subaccountId' is set
        if (subaccountId == null) {
            throw new ApiException("Missing the required parameter 'subaccountId' when calling accountSubaccountStatSubaccountIdGet(Async)");
        }

        return accountSubaccountStatSubaccountIdGetCall(from, to, subaccountId, _callback);
     ...
     */
    public List<Stat> accountSubaccountStatSubaccountIdGet(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId) throws ApiException {
        ApiResponse<List<Stat>> localVarResp = accountSubaccountStatSubaccountIdGetWithHttpInfo(from, to, subaccountId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Stat>> accountSubaccountStatSubaccountIdGetWithHttpInfo(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId) throws ApiException {
        okhttp3.Call localVarCall = accountSubaccountStatSubaccountIdGetValidateBeforeCall(from, to, subaccountId, null);
     ...
     */
    public okhttp3.Call accountSubaccountStatSubaccountIdGetAsync(@javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback<List<Stat>> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountSubaccountStatSubaccountIdGetValidateBeforeCall(from, to, subaccountId, _callback);
        Type localVarReturnType = new TypeToken<List<Stat>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAggregateStatsByGroup
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Aggregated email stats for the group within the specified date range </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAggregateStatsByGroupCall(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/account/subaccount/stat/{subaccount_id}/group"
            .replace("{" + "subaccount_id" + "}", localVarApiClient.escapeString(subaccountId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAggregateStatsByGroupValidateBeforeCall(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'group' is set
        if (group == null) {
            throw new ApiException("Missing the required parameter 'group' when calling getAggregateStatsByGroup(Async)");
        }

        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getAggregateStatsByGroup(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getAggregateStatsByGroup(Async)");
        }

        // verify the required parameter 'subaccountId' is set
        if (subaccountId == null) {
            throw new ApiException("Missing the required parameter 'subaccountId' when calling getAggregateStatsByGroup(Async)");
        }

        return getAggregateStatsByGroupCall(group, from, to, subaccountId, _callback);
     ...
     */
    public AggregateStat getAggregateStatsByGroup(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId) throws ApiException {
        ApiResponse<AggregateStat> localVarResp = getAggregateStatsByGroupWithHttpInfo(group, from, to, subaccountId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AggregateStat> getAggregateStatsByGroupWithHttpInfo(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId) throws ApiException {
        okhttp3.Call localVarCall = getAggregateStatsByGroupValidateBeforeCall(group, from, to, subaccountId, null);
        Type localVarReturnType = new TypeToken<AggregateStat>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAggregateStatsByGroupAsync(@javax.annotation.Nonnull String group, @javax.annotation.Nonnull LocalDate from, @javax.annotation.Nonnull LocalDate to, @javax.annotation.Nonnull Long subaccountId, final ApiCallback<AggregateStat> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAggregateStatsByGroupValidateBeforeCall(group, from, to, subaccountId, _callback);
        Type localVarReturnType = new TypeToken<AggregateStat>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
