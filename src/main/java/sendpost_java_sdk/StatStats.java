...
public class StatStats {
  ...
  public StatStats processed(@javax.annotation.Nullable Integer processed) {
  ...
  public StatStats sent(@javax.annotation.Nullable Integer sent) {
    this.sent = sent;
    return this;
  }
  ...
  public StatStats delivered(@javax.annotation.Nullable Integer delivered) {
  ...
  public StatStats dropped(@javax.annotation.Nullable Integer dropped) {
  ...
  public StatStats smtpDropped(@javax.annotation.Nullable Integer smtpDropped) {
  ...
  public StatStats hardBounced(@javax.annotation.Nullable Integer hardBounced) {
  ...
  public StatStats softBounced(@javax.annotation.Nullable Integer softBounced) {
  ...
  public StatStats opened(@javax.annotation.Nullable Integer opened) {
    this.opened = opened;
    return this;
  }
  ...
  public StatStats clicked(@javax.annotation.Nullable Integer clicked) {
  ...
  public StatStats unsubscribed(@javax.annotation.Nullable Integer unsubscribed) {
  ...
  public StatStats spam(@javax.annotation.Nullable Integer spam) {
    this.spam = spam;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatStats statStats = (StatStats) o;
    return Objects.equals(this.processed, statStats.processed) &&
        Objects.equals(this.sent, statStats.sent) &&
        Objects.equals(this.delivered, statStats.delivered) &&
        Objects.equals(this.dropped, statStats.dropped) &&
        Objects.equals(this.smtpDropped, statStats.smtpDropped) &&
        Objects.equals(this.hardBounced, statStats.hardBounced) &&
        Objects.equals(this.softBounced, statStats.softBounced) &&
        Objects.equals(this.opened, statStats.opened) &&
        Objects.equals(this.clicked, statStats.clicked) &&
        Objects.equals(this.unsubscribed, statStats.unsubscribed) &&
        Objects.equals(this.spam, statStats.spam);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatStats is not found in the empty JSON string", StatStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatStats.class));

       return (TypeAdapter<T>) new TypeAdapter<StatStats>() {
           @Override
           public void write(JsonWriter out, StatStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatStats
   * @throws IOException if the JSON string is invalid with respect to StatStats
   */
  public static StatStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatStats.class);
  }

  /**
   * Convert an instance of StatStats to an JSON string
   *
   * @return JSON string
   */
