...
public class AggregateStat {
  ...
  public AggregateStat processed(@javax.annotation.Nullable Integer processed) {
  ...
  public AggregateStat sent(@javax.annotation.Nullable Integer sent) {
    this.sent = sent;
    return this;
  }
  ...
  public AggregateStat delivered(@javax.annotation.Nullable Integer delivered) {
  ...
  public AggregateStat dropped(@javax.annotation.Nullable Integer dropped) {
  ...
  public AggregateStat smtpDropped(@javax.annotation.Nullable Integer smtpDropped) {
  ...
  public AggregateStat hardBounced(@javax.annotation.Nullable Integer hardBounced) {
  ...
  public AggregateStat softBounced(@javax.annotation.Nullable Integer softBounced) {
  ...
  public AggregateStat opened(@javax.annotation.Nullable Integer opened) {
    this.opened = opened;
    return this;
  }
  ...
  public AggregateStat clicked(@javax.annotation.Nullable Integer clicked) {
  ...
  public AggregateStat unsubscribed(@javax.annotation.Nullable Integer unsubscribed) {
  ...
  public AggregateStat spam(@javax.annotation.Nullable Integer spam) {
    this.spam = spam;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AggregateStat aggregateStat = (AggregateStat) o;
    return Objects.equals(this.processed, aggregateStat.processed) &&
        Objects.equals(this.sent, aggregateStat.sent) &&
        Objects.equals(this.delivered, aggregateStat.delivered) &&
        Objects.equals(this.dropped, aggregateStat.dropped) &&
        Objects.equals(this.smtpDropped, aggregateStat.smtpDropped) &&
        Objects.equals(this.hardBounced, aggregateStat.hardBounced) &&
        Objects.equals(this.softBounced, aggregateStat.softBounced) &&
        Objects.equals(this.opened, aggregateStat.opened) &&
        Objects.equals(this.clicked, aggregateStat.clicked) &&
        Objects.equals(this.unsubscribed, aggregateStat.unsubscribed) &&
        Objects.equals(this.spam, aggregateStat.spam);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AggregateStat
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregateStat.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregateStat is not found in the empty JSON string", AggregateStat.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AggregateStat.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AggregateStat` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregateStat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregateStat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregateStat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregateStat.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregateStat>() {
           @Override
           public void write(JsonWriter out, AggregateStat value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AggregateStat read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AggregateStat given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AggregateStat
   * @throws IOException if the JSON string is invalid with respect to AggregateStat
   */
  public static AggregateStat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregateStat.class);
  }

  /**
   * Convert an instance of AggregateStat to an JSON string
   *
   * @return JSON string
   */
