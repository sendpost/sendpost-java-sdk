...
public class MessageHeaderTo {
  ...
  public MessageHeaderTo() {
  }

  public MessageHeaderTo name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MessageHeaderTo email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public MessageHeaderTo cc(@javax.annotation.Nullable List<String> cc) {
    this.cc = cc;
    return this;
  }

  public MessageHeaderTo addCcItem(String ccItem) {
    if (this.cc == null) {
  ...
  public MessageHeaderTo bcc(@javax.annotation.Nullable List<String> bcc) {
    this.bcc = bcc;
    return this;
  }

  public MessageHeaderTo addBccItem(String bccItem) {
    if (this.bcc == null) {
  ...
  public MessageHeaderTo customFields(@javax.annotation.Nullable Map<String, String> customFields) {
    this.customFields = customFields;
    return this;
  }

  public MessageHeaderTo putCustomFieldsItem(String key, String customFieldsItem) {
  ...
  public boolean equals(Object o) {
    ...
    MessageHeaderTo messageHeaderTo = (MessageHeaderTo) o;
    return Objects.equals(this.name, messageHeaderTo.name) &&
        Objects.equals(this.email, messageHeaderTo.email) &&
        Objects.equals(this.cc, messageHeaderTo.cc) &&
        Objects.equals(this.bcc, messageHeaderTo.bcc) &&
        Objects.equals(this.customFields, messageHeaderTo.customFields);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, email, cc, bcc, customFields);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MessageHeaderTo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageHeaderTo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageHeaderTo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageHeaderTo is not found in the empty JSON string", MessageHeaderTo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageHeaderTo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageHeaderTo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageHeaderTo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageHeaderTo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageHeaderTo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageHeaderTo.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageHeaderTo>() {
           @Override
           public void write(JsonWriter out, MessageHeaderTo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageHeaderTo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageHeaderTo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageHeaderTo
   * @throws IOException if the JSON string is invalid with respect to MessageHeaderTo
   */
  public static MessageHeaderTo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageHeaderTo.class);
  }

  /**
   * Convert an instance of MessageHeaderTo to an JSON string
   *
   * @return JSON string
   */
