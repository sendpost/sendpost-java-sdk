...
import sendpost_java_sdk.CreateSuppressionRequestHardBounceInner;
import sendpost_java_sdk.CreateSuppressionRequestManualInner;
import sendpost_java_sdk.CreateSuppressionRequestSpamComplaintInner;
import sendpost_java_sdk.CreateSuppressionRequestUnsubscribeInner;
...
public class CreateSuppressionRequest {
  ...
  private List<CreateSuppressionRequestHardBounceInner> hardBounce = new ArrayList<>();

  public static final String SERIALIZED_NAME_MANUAL = "manual";
  @SerializedName(SERIALIZED_NAME_MANUAL)
  @javax.annotation.Nullable
  private List<CreateSuppressionRequestManualInner> manual = new ArrayList<>();

  public static final String SERIALIZED_NAME_UNSUBSCRIBE = "unsubscribe";
  @SerializedName(SERIALIZED_NAME_UNSUBSCRIBE)
  @javax.annotation.Nullable
  private List<CreateSuppressionRequestUnsubscribeInner> unsubscribe = new ArrayList<>();

  public static final String SERIALIZED_NAME_SPAM_COMPLAINT = "spamComplaint";
  @SerializedName(SERIALIZED_NAME_SPAM_COMPLAINT)
  @javax.annotation.Nullable
  private List<CreateSuppressionRequestSpamComplaintInner> spamComplaint = new ArrayList<>();

  public CreateSuppressionRequest() {
  }

  public CreateSuppressionRequest hardBounce(@javax.annotation.Nullable List<CreateSuppressionRequestHardBounceInner> hardBounce) {
    this.hardBounce = hardBounce;
    return this;
  }

  public CreateSuppressionRequest addHardBounceItem(CreateSuppressionRequestHardBounceInner hardBounceItem) {
    if (this.hardBounce == null) {
      this.hardBounce = new ArrayList<>();
    }
   ...
   */
  @javax.annotation.Nullable
  public List<CreateSuppressionRequestHardBounceInner> getHardBounce() {
    return hardBounce;
  }

  public void setHardBounce(@javax.annotation.Nullable List<CreateSuppressionRequestHardBounceInner> hardBounce) {
    this.hardBounce = hardBounce;
  }


  public CreateSuppressionRequest manual(@javax.annotation.Nullable List<CreateSuppressionRequestManualInner> manual) {
    this.manual = manual;
    return this;
  }

  public CreateSuppressionRequest addManualItem(CreateSuppressionRequestManualInner manualItem) {
    if (this.manual == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<CreateSuppressionRequestManualInner> getManual() {
    return manual;
  }

  public void setManual(@javax.annotation.Nullable List<CreateSuppressionRequestManualInner> manual) {
    this.manual = manual;
  }


  public CreateSuppressionRequest unsubscribe(@javax.annotation.Nullable List<CreateSuppressionRequestUnsubscribeInner> unsubscribe) {
    this.unsubscribe = unsubscribe;
    return this;
  }

  public CreateSuppressionRequest addUnsubscribeItem(CreateSuppressionRequestUnsubscribeInner unsubscribeItem) {
    if (this.unsubscribe == null) {
      this.unsubscribe = new ArrayList<>();
    }
   ...
   */
  @javax.annotation.Nullable
  public List<CreateSuppressionRequestUnsubscribeInner> getUnsubscribe() {
    return unsubscribe;
  }

  public void setUnsubscribe(@javax.annotation.Nullable List<CreateSuppressionRequestUnsubscribeInner> unsubscribe) {
    this.unsubscribe = unsubscribe;
  }


  public CreateSuppressionRequest spamComplaint(@javax.annotation.Nullable List<CreateSuppressionRequestSpamComplaintInner> spamComplaint) {
    this.spamComplaint = spamComplaint;
    return this;
  }

  public CreateSuppressionRequest addSpamComplaintItem(CreateSuppressionRequestSpamComplaintInner spamComplaintItem) {
    if (this.spamComplaint == null) {
      this.spamComplaint = new ArrayList<>();
    }
   ...
   */
  @javax.annotation.Nullable
  public List<CreateSuppressionRequestSpamComplaintInner> getSpamComplaint() {
    return spamComplaint;
  }

  public void setSpamComplaint(@javax.annotation.Nullable List<CreateSuppressionRequestSpamComplaintInner> spamComplaint) {
    this.spamComplaint = spamComplaint;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateSuppressionRequest createSuppressionRequest = (CreateSuppressionRequest) o;
    return Objects.equals(this.hardBounce, createSuppressionRequest.hardBounce) &&
        Objects.equals(this.manual, createSuppressionRequest.manual) &&
        Objects.equals(this.unsubscribe, createSuppressionRequest.unsubscribe) &&
        Objects.equals(this.spamComplaint, createSuppressionRequest.spamComplaint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hardBounce, manual, unsubscribe, spamComplaint);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSuppressionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSuppressionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSuppressionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSuppressionRequest is not found in the empty JSON string", CreateSuppressionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSuppressionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSuppressionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("hardBounce") != null && !jsonObj.get("hardBounce").isJsonNull()) {
        JsonArray jsonArrayhardBounce = jsonObj.getAsJsonArray("hardBounce");
        if (jsonArrayhardBounce != null) {
          // ensure the json data is an array
          if (!jsonObj.get("hardBounce").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `hardBounce` to be an array in the JSON string but got `%s`", jsonObj.get("hardBounce").toString()));
          }

          // validate the optional field `hardBounce` (array)
          for (int i = 0; i < jsonArrayhardBounce.size(); i++) {
            CreateSuppressionRequestHardBounceInner.validateJsonElement(jsonArrayhardBounce.get(i));
          };
        }
      }
      if (jsonObj.get("manual") != null && !jsonObj.get("manual").isJsonNull()) {
        JsonArray jsonArraymanual = jsonObj.getAsJsonArray("manual");
        if (jsonArraymanual != null) {
          // ensure the json data is an array
          if (!jsonObj.get("manual").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `manual` to be an array in the JSON string but got `%s`", jsonObj.get("manual").toString()));
          }

          // validate the optional field `manual` (array)
          for (int i = 0; i < jsonArraymanual.size(); i++) {
            CreateSuppressionRequestManualInner.validateJsonElement(jsonArraymanual.get(i));
          };
        }
      }
      if (jsonObj.get("unsubscribe") != null && !jsonObj.get("unsubscribe").isJsonNull()) {
        JsonArray jsonArrayunsubscribe = jsonObj.getAsJsonArray("unsubscribe");
        if (jsonArrayunsubscribe != null) {
          // ensure the json data is an array
          if (!jsonObj.get("unsubscribe").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `unsubscribe` to be an array in the JSON string but got `%s`", jsonObj.get("unsubscribe").toString()));
          }

          // validate the optional field `unsubscribe` (array)
          for (int i = 0; i < jsonArrayunsubscribe.size(); i++) {
            CreateSuppressionRequestUnsubscribeInner.validateJsonElement(jsonArrayunsubscribe.get(i));
          };
        }
      }
      if (jsonObj.get("spamComplaint") != null && !jsonObj.get("spamComplaint").isJsonNull()) {
        JsonArray jsonArrayspamComplaint = jsonObj.getAsJsonArray("spamComplaint");
        if (jsonArrayspamComplaint != null) {
          // ensure the json data is an array
          if (!jsonObj.get("spamComplaint").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `spamComplaint` to be an array in the JSON string but got `%s`", jsonObj.get("spamComplaint").toString()));
          }

          // validate the optional field `spamComplaint` (array)
          for (int i = 0; i < jsonArrayspamComplaint.size(); i++) {
            CreateSuppressionRequestSpamComplaintInner.validateJsonElement(jsonArrayspamComplaint.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSuppressionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSuppressionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSuppressionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSuppressionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSuppressionRequest>() {
           @Override
           public void write(JsonWriter out, CreateSuppressionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSuppressionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSuppressionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSuppressionRequest
   * @throws IOException if the JSON string is invalid with respect to CreateSuppressionRequest
   */
  public static CreateSuppressionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSuppressionRequest.class);
  }

  /**
   * Convert an instance of CreateSuppressionRequest to an JSON string
   *
   * @return JSON string
   */
