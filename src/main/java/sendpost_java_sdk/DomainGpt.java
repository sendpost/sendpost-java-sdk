...
public class DomainGpt {
  ...
  public DomainGpt host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public DomainGpt type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public DomainGpt textValue(@javax.annotation.Nullable String textValue) {
  ...
  public boolean equals(Object o) {
    ...
    DomainGpt domainGpt = (DomainGpt) o;
    return Objects.equals(this.host, domainGpt.host) &&
        Objects.equals(this.type, domainGpt.type) &&
        Objects.equals(this.textValue, domainGpt.textValue);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainGpt
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainGpt.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainGpt is not found in the empty JSON string", DomainGpt.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainGpt.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainGpt` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainGpt.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainGpt' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainGpt> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainGpt.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainGpt>() {
           @Override
           public void write(JsonWriter out, DomainGpt value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainGpt read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainGpt given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainGpt
   * @throws IOException if the JSON string is invalid with respect to DomainGpt
   */
  public static DomainGpt fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainGpt.class);
  }

  /**
   * Convert an instance of DomainGpt to an JSON string
   *
   * @return JSON string
   */
