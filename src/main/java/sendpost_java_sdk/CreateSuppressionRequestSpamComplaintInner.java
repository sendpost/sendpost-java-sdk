...
public class CreateSuppressionRequestSpamComplaintInner {
  public static final String SERIALIZED_NAME_EMAIL = "email";
  @SerializedName(SERIALIZED_NAME_EMAIL)
  @javax.annotation.Nullable
  private String email;

  public CreateSuppressionRequestSpamComplaintInner() {
  }

  public CreateSuppressionRequestSpamComplaintInner email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateSuppressionRequestSpamComplaintInner createSuppressionRequestSpamComplaintInner = (CreateSuppressionRequestSpamComplaintInner) o;
    return Objects.equals(this.email, createSuppressionRequestSpamComplaintInner.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSuppressionRequestSpamComplaintInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSuppressionRequestSpamComplaintInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSuppressionRequestSpamComplaintInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSuppressionRequestSpamComplaintInner is not found in the empty JSON string", CreateSuppressionRequestSpamComplaintInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSuppressionRequestSpamComplaintInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSuppressionRequestSpamComplaintInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSuppressionRequestSpamComplaintInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSuppressionRequestSpamComplaintInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSuppressionRequestSpamComplaintInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSuppressionRequestSpamComplaintInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSuppressionRequestSpamComplaintInner>() {
           @Override
           public void write(JsonWriter out, CreateSuppressionRequestSpamComplaintInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSuppressionRequestSpamComplaintInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSuppressionRequestSpamComplaintInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSuppressionRequestSpamComplaintInner
   * @throws IOException if the JSON string is invalid with respect to CreateSuppressionRequestSpamComplaintInner
   */
  public static CreateSuppressionRequestSpamComplaintInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSuppressionRequestSpamComplaintInner.class);
  }

  /**
   * Convert an instance of CreateSuppressionRequestSpamComplaintInner to an JSON string
   *
   * @return JSON string
   */
