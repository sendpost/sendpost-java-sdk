...
public class MessageTo {
  ...
  public MessageTo name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MessageTo email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public MessageTo cc(@javax.annotation.Nullable List<String> cc) {
    this.cc = cc;
    return this;
  }

  public MessageTo addCcItem(String ccItem) {
    if (this.cc == null) {
  ...
  public MessageTo bcc(@javax.annotation.Nullable List<String> bcc) {
    this.bcc = bcc;
    return this;
  }

  public MessageTo addBccItem(String bccItem) {
    if (this.bcc == null) {
  ...
  public MessageTo customFields(@javax.annotation.Nullable Map<String, String> customFields) {
    this.customFields = customFields;
    return this;
  }

  public MessageTo putCustomFieldsItem(String key, String customFieldsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, messageTo.name) &&
        Objects.equals(this.email, messageTo.email) &&
        Objects.equals(this.cc, messageTo.cc) &&
        Objects.equals(this.bcc, messageTo.bcc) &&
        Objects.equals(this.customFields, messageTo.customFields);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageTo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageTo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageTo is not found in the empty JSON string", MessageTo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageTo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageTo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageTo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageTo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageTo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageTo.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageTo>() {
           @Override
           public void write(JsonWriter out, MessageTo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageTo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageTo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageTo
   * @throws IOException if the JSON string is invalid with respect to MessageTo
   */
  public static MessageTo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageTo.class);
  }

  /**
   * Convert an instance of MessageTo to an JSON string
   *
   * @return JSON string
   */
