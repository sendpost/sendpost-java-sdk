...
public class DomainReturnPath {
  ...
  public DomainReturnPath() {
  }

  public DomainReturnPath host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public DomainReturnPath type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public DomainReturnPath textValue(@javax.annotation.Nullable String textValue) {
  ...
  public boolean equals(Object o) {
    ...
    DomainReturnPath domainReturnPath = (DomainReturnPath) o;
    return Objects.equals(this.host, domainReturnPath.host) &&
        Objects.equals(this.type, domainReturnPath.type) &&
        Objects.equals(this.textValue, domainReturnPath.textValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainReturnPath {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainReturnPath
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainReturnPath.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainReturnPath is not found in the empty JSON string", DomainReturnPath.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainReturnPath.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainReturnPath` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainReturnPath.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainReturnPath' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainReturnPath> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainReturnPath.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainReturnPath>() {
           @Override
           public void write(JsonWriter out, DomainReturnPath value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainReturnPath read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainReturnPath given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainReturnPath
   * @throws IOException if the JSON string is invalid with respect to DomainReturnPath
   */
  public static DomainReturnPath fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainReturnPath.class);
  }

  /**
   * Convert an instance of DomainReturnPath to an JSON string
   *
   * @return JSON string
   */
