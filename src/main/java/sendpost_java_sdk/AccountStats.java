...
import sendpost_java_sdk.AccountStatsStat;
...
public class AccountStats {
  ...
  @javax.annotation.Nullable
  private AccountStatsStat stat;

  public AccountStats() {
  }

  public AccountStats date(@javax.annotation.Nullable LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  public AccountStats stat(@javax.annotation.Nullable AccountStatsStat stat) {
    this.stat = stat;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AccountStatsStat getStat() {
    return stat;
  }

  public void setStat(@javax.annotation.Nullable AccountStatsStat stat) {
    this.stat = stat;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountStats accountStats = (AccountStats) o;
    return Objects.equals(this.date, accountStats.date) &&
        Objects.equals(this.stat, accountStats.stat);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountStats is not found in the empty JSON string", AccountStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `stat`
      if (jsonObj.get("stat") != null && !jsonObj.get("stat").isJsonNull()) {
        AccountStatsStat.validateJsonElement(jsonObj.get("stat"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountStats.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountStats>() {
           @Override
           public void write(JsonWriter out, AccountStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountStats
   * @throws IOException if the JSON string is invalid with respect to AccountStats
   */
  public static AccountStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountStats.class);
  }

  /**
   * Convert an instance of AccountStats to an JSON string
   *
   * @return JSON string
   */
