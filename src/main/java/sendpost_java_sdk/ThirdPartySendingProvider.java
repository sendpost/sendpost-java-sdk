...
public class ThirdPartySendingProvider {
  ...
  public ThirdPartySendingProvider() {
  }

  public ThirdPartySendingProvider id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ThirdPartySendingProvider name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ThirdPartySendingProvider type(@javax.annotation.Nullable Integer type) {
    this.type = type;
    return this;
  }
  ...
  public ThirdPartySendingProvider domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ThirdPartySendingProvider endpoint(@javax.annotation.Nullable String endpoint) {
  ...
  public ThirdPartySendingProvider key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public ThirdPartySendingProvider secret(@javax.annotation.Nullable String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public ThirdPartySendingProvider port(@javax.annotation.Nullable Integer port) {
    this.port = port;
    return this;
  }
  ...
  public ThirdPartySendingProvider oauthToken(@javax.annotation.Nullable String oauthToken) {
  ...
  public ThirdPartySendingProvider retryTime(@javax.annotation.Nullable Integer retryTime) {
  ...
  public void setRetryTime(@javax.annotation.Nullable Integer retryTime) {
    this.retryTime = retryTime;
  }


  public ThirdPartySendingProvider created(@javax.annotation.Nullable Integer created) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartySendingProvider thirdPartySendingProvider = (ThirdPartySendingProvider) o;
    return Objects.equals(this.id, thirdPartySendingProvider.id) &&
        Objects.equals(this.name, thirdPartySendingProvider.name) &&
        Objects.equals(this.type, thirdPartySendingProvider.type) &&
        Objects.equals(this.domain, thirdPartySendingProvider.domain) &&
        Objects.equals(this.endpoint, thirdPartySendingProvider.endpoint) &&
        Objects.equals(this.key, thirdPartySendingProvider.key) &&
        Objects.equals(this.secret, thirdPartySendingProvider.secret) &&
        Objects.equals(this.port, thirdPartySendingProvider.port) &&
        Objects.equals(this.oauthToken, thirdPartySendingProvider.oauthToken) &&
        Objects.equals(this.retryTime, thirdPartySendingProvider.retryTime) &&
        Objects.equals(this.created, thirdPartySendingProvider.created);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, type, domain, endpoint, key, secret, port, oauthToken, retryTime, created);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartySendingProvider {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ThirdPartySendingProvider
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThirdPartySendingProvider.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartySendingProvider is not found in the empty JSON string", ThirdPartySendingProvider.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThirdPartySendingProvider.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThirdPartySendingProvider` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartySendingProvider.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartySendingProvider' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartySendingProvider> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartySendingProvider.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartySendingProvider>() {
           @Override
           public void write(JsonWriter out, ThirdPartySendingProvider value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ThirdPartySendingProvider read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ThirdPartySendingProvider given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ThirdPartySendingProvider
   * @throws IOException if the JSON string is invalid with respect to ThirdPartySendingProvider
   */
  public static ThirdPartySendingProvider fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartySendingProvider.class);
  }

  /**
   * Convert an instance of ThirdPartySendingProvider to an JSON string
   *
   * @return JSON string
   */
