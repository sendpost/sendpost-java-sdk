 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-12-22T14:42:05.038948+05:30[Asia/Kolkata]", comments = "Generator version: 7.13.0")
public class DeleteSuppression200Response {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  @javax.annotation.Nullable
  private String message;

  public DeleteSuppression200Response() {
  }

  public DeleteSuppression200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSuppression200Response deleteSuppression200Response = (DeleteSuppression200Response) o;
    return Objects.equals(this.message, deleteSuppression200Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSuppression200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSuppression200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSuppression200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSuppression200Response is not found in the empty JSON string", DeleteSuppression200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSuppression200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSuppression200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSuppression200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSuppression200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSuppression200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSuppression200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSuppression200Response>() {
           @Override
           public void write(JsonWriter out, DeleteSuppression200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSuppression200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSuppression200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSuppression200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteSuppression200Response
   */
  public static DeleteSuppression200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSuppression200Response.class);
  }

  /**
   * Convert an instance of DeleteSuppression200Response to an JSON string
   *
   * @return JSON string
   */
