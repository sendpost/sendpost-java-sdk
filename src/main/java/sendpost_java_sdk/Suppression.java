...
public class Suppression {
  ...
  public Suppression id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Suppression reason(@javax.annotation.Nullable Integer reason) {
    this.reason = reason;
    return this;
  }
  ...
  public Suppression created(@javax.annotation.Nullable Long created) {
