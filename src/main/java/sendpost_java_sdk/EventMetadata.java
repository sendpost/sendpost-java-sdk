...
import sendpost_java_sdk.Device;
import sendpost_java_sdk.GeoLocation;
import sendpost_java_sdk.OperatingSystem;
import sendpost_java_sdk.UserAgent;
...
public class EventMetadata {
  ...
  public static final String SERIALIZED_NAME_CLICKED_U_R_L = "clickedURL";
  @SerializedName(SERIALIZED_NAME_CLICKED_U_R_L)
  @javax.annotation.Nullable
  private String clickedURL;

  public static final String SERIALIZED_NAME_TRACKED_I_P = "trackedIP";
  @SerializedName(SERIALIZED_NAME_TRACKED_I_P)
  @javax.annotation.Nullable
  private String trackedIP;
  ...
  public EventMetadata smtpCode(@javax.annotation.Nullable Integer smtpCode) {
  ...
  public EventMetadata smtpDescription(@javax.annotation.Nullable String smtpDescription) {
  ...
  public EventMetadata userAgent(@javax.annotation.Nullable UserAgent userAgent) {
  ...
  public void setUserAgent(@javax.annotation.Nullable UserAgent userAgent) {
    this.userAgent = userAgent;
  }


  public EventMetadata os(@javax.annotation.Nullable OperatingSystem os) {
    this.os = os;
    return this;
  }
  ...
  public EventMetadata device(@javax.annotation.Nullable Device device) {
    this.device = device;
    return this;
  }
  ...
  public EventMetadata geo(@javax.annotation.Nullable GeoLocation geo) {
    this.geo = geo;
    return this;
  }
  ...
  public void setGeo(@javax.annotation.Nullable GeoLocation geo) {
    this.geo = geo;
  }


  public EventMetadata clickedURL(@javax.annotation.Nullable String clickedURL) {
  ...
  public void setClickedURL(@javax.annotation.Nullable String clickedURL) {
    this.clickedURL = clickedURL;
  }


  public EventMetadata trackedIP(@javax.annotation.Nullable String trackedIP) {
  ...
  public void setTrackedIP(@javax.annotation.Nullable String trackedIP) {
    this.trackedIP = trackedIP;
  }


  public EventMetadata rawUserAgent(@javax.annotation.Nullable String rawUserAgent) {
  ...
  public void setRawUserAgent(@javax.annotation.Nullable String rawUserAgent) {
    this.rawUserAgent = rawUserAgent;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.smtpCode, eventMetadata.smtpCode) &&
        Objects.equals(this.smtpDescription, eventMetadata.smtpDescription) &&
        Objects.equals(this.userAgent, eventMetadata.userAgent) &&
        Objects.equals(this.os, eventMetadata.os) &&
        Objects.equals(this.device, eventMetadata.device) &&
        Objects.equals(this.geo, eventMetadata.geo) &&
        Objects.equals(this.clickedURL, eventMetadata.clickedURL) &&
        Objects.equals(this.trackedIP, eventMetadata.trackedIP) &&
        Objects.equals(this.rawUserAgent, eventMetadata.rawUserAgent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(smtpCode, smtpDescription, userAgent, os, device, geo, clickedURL, trackedIP, rawUserAgent);
  }
  ...
  public String toString() {
    ...
    sb.append("    trackedIP: ").append(toIndentedString(trackedIP)).append("\n");
  ...
  static {
    ...
    openapiFields.add("clickedURL");
    openapiFields.add("trackedIP");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("userAgent") != null && !jsonObj.get("userAgent").isJsonNull()) {
        UserAgent.validateJsonElement(jsonObj.get("userAgent"));
      }
      ...
      if (jsonObj.get("geo") != null && !jsonObj.get("geo").isJsonNull()) {
        GeoLocation.validateJsonElement(jsonObj.get("geo"));
      }
      if ((jsonObj.get("clickedURL") != null && !jsonObj.get("clickedURL").isJsonNull()) && !jsonObj.get("clickedURL").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `clickedURL` to be a primitive type in the JSON string but got `%s`", jsonObj.get("clickedURL").toString()));
      }
      if ((jsonObj.get("trackedIP") != null && !jsonObj.get("trackedIP").isJsonNull()) && !jsonObj.get("trackedIP").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `trackedIP` to be a primitive type in the JSON string but got `%s`", jsonObj.get("trackedIP").toString()));
      }
